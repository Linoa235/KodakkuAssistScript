...
[ScriptType(name: "LV.10 Basic Training Enemy Parties", territorys: [], guid: "a808ed0b-8058-49a8-a4fe-6c663ebee5f3", version: "0.0.0.1", Author: "Linoa235")]
...
public class Basic_Training_Enemy_Parties
{
    ...
    [ScriptMethod(name: "Wing Cutter", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:1015"])]
    ...
    [ScriptMethod(name: "Moldy Sneeze", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:579"])]
    ...
    [ScriptMethod(name: "Instance Indication", eventType: EventTypeEnum.Director, eventCondition: ["Instance:80032711"])]
    public void Notify(Event @event, ScriptAccessory accessory)
    {
        ...
        {
            if (isText) accessory.Method.TextInfo("Wait inside the purple circle for enemies to appear", duration: 4700, true);
            accessory.TTS("Wait inside the purple circle for enemies to appear", isTTS, isDRTTS);
        }
    }
