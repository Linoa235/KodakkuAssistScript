...
[ScriptType(name: Name, territorys: [822], guid: "f4e268c5-fe31-4fd6-8a21-fe9200c644a1",
...
public class MtGulg
{
    ...
    private const string Name = "LV.79 The Twinning [Mt. Gulg]";
    ...
    [ScriptMethod(name: "Immolation", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16810"])]
    public void Immolation(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawCircle(sa, ev.EffectPosition, new Vector2(6f), 2700, $"Immolation-{ev.SourceId}", sa.Data.DefaultDangerColor, scaleByTime: true);
    }

    [ScriptMethod(name: "Immolation Clear", eventType: EventTypeEnum.CancelAction, eventCondition: ["ActionId:16810"], userControl: false)]
    public void ImmolationClear(Event ev, ScriptAccessory sa)
    {
        sa.Method.RemoveDraw($"Immolation-{ev.SourceId}");
    }

    [ScriptMethod(name: "Tail Smash", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16811"])]
    public void TailSmash(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawFanObject(sa, ev.SourceId, float.Pi, new Vector2(15f), 120, 3200, $"Tail Smash-{ev.SourceId}", sa.Data.DefaultDangerColor, scaleByTime: true);
    }

    [ScriptMethod(name: "Tail Smash Clear", eventType: EventTypeEnum.CancelAction, eventCondition: ["ActionId:16811"], userControl: false)]
    public void TailSmashClear(Event ev, ScriptAccessory sa)
    {
        sa.Method.RemoveDraw($"Tail Smash-{ev.SourceId}");
    }

    [ScriptMethod(name: "Heavenslash", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16809"])]
    public void Heavenslash(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawFanObject(sa, ev.SourceId, 0, new Vector2(8f), 90, 2700, $"Heavenslash-{ev.SourceId}", sa.Data.DefaultDangerColor, scaleByTime: true);
    }

    [ScriptMethod(name: "Heavenslash Clear", eventType: EventTypeEnum.CancelAction, eventCondition: ["ActionId:16809"], userControl: false)]
    public void HeavenslashClear(Event ev, ScriptAccessory sa)
    {
        sa.Method.RemoveDraw($"Heavenslash-{ev.SourceId}");
    }
    #endregion

    #region Before Boss 2
    [ScriptMethod(name: "Sanctification", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16814"])]
    public void Sanctification(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawFanObject(sa, ev.SourceId, 0, new Vector2(12f), 90, 4700, $"Sanctification-{ev.SourceId}", sa.Data.DefaultDangerColor);
    }


    [ScriptMethod(name: "Sanctification Clear", eventType: EventTypeEnum.CancelAction, eventCondition: ["ActionId:16814"], userControl: false)]
    public void SanctificationClear(Event ev, ScriptAccessory sa)
    {
        sa.Method.RemoveDraw($"Sanctification-{ev.SourceId}");
    }

    [ScriptMethod(name: "Punitive Light", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16815"])]
    public void PunitiveLight(Event ev, ScriptAccessory sa)
    {
        string msg = "";
        if (isMark)
        {
    ...
    [ScriptMethod(name: "Right Palm", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16247|16248)$"])]
    public void RightPalm(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawRectObjectNoTarget(sa, ev.SourceId, new Vector2(15f, 30f), 4200, $"Right Palm-{ev.SourceId}", sa.Data.DefaultDangerColor, offset: new Vector3(7.5f, 0, 0));
    }

    [ScriptMethod(name: "Left Palm", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16249|16250)$"])]
    public void LeftPalm(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawRectObjectNoTarget(sa, ev.SourceId, new Vector2(15f, 30f), 4200, $"Left Palm-{ev.SourceId}", sa.Data.DefaultDangerColor, offset: new Vector3(-7.5f, 0, 0));
    }
    #endregion
    ...
    [ScriptMethod(name: "Tankbuster Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15611"])]
    ...
    [ScriptMethod(name: "Lumen Infinitum", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16818"])]
    public void LumenInfinitum(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawRectObjectNoTarget(sa, ev.SourceId, new Vector2(4.5f, 40f), 3400, $"Lumen Infinitum-{ev.SourceId}", sa.Data.DefaultDangerColor);
    }

    [ScriptMethod(name: "Typhoon Wing", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(15616|17153)$"])]
    public void TyphoonWing(Event ev, ScriptAccessory sa)
    {
        var duration = ev.ActionId == 15616 ? 4700 : 6700; 
        DrawHelper.DrawFanObjectNoRot(sa, ev.SourceId, new Vector2(20f), 60, duration, $"Typhoon Wing-{ev.SourceId}", sa.Data.DefaultDangerColor);
    }

    [ScriptMethod(name: "Hurricane Wing", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15619"])]
    public void HurricaneWing(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawCircle(sa, ev.EffectPosition, new Vector2(10f), 4700, $"Hurricane Wing-{ev.SourceId}", sa.Data.DefaultDangerColor, scaleByTime: true);
    }
     
    [ScriptMethod(name: "AOE Notify Boss 1", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15613"])]
    ...
    [ScriptMethod(name: "AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15627"])]
    ...
    [ScriptMethod(name: "Exegesis", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16989|15622|16988)$"])]
    public void Exegesis(Event ev, ScriptAccessory sa)
    {
        List<Vector3> blocks16989 = new List<Vector3>()
        {
            new Vector3(-240f, 210f, -55f),         // mid -> up
            new Vector3(-250f, 210f, -45f),         // upperRight -> up
            new Vector3(-250f, 210f, -65f),         // lowerRight -> up
            new Vector3(-230f, 210f, -65f),         // lowerLeft -> up
            new Vector3(-230f, 210f, -45f),         // upperLeft -> up
        };

        List<Vector3> blocks15622 = new List<Vector3>()
        {
            new Vector3(-240f, 210f, -45f),         // midupper -> up
            new Vector3(-240f, 210f, -65f),         // midLower -> up
        };

        List<Vector3> blocks16988 = new List<Vector3>()
        {
            new Vector3(-230f, 210f, -55f),         // left -> up
            new Vector3(-250f, 210f, -55f),         // right -> up
            new Vector3(-240f, 210f, -55f),         // mid -> up
            new Vector3(-240f, 210f, -45f),         // midupper -> up
            new Vector3(-240f, 210f, -65f),         // midLower -> up
        };
        ...
        {
            case 16989:
                foreach (var pos in blocks16989)
                {
                    DrawHelper.DrawRectPosNoTarget(sa, pos, new Vector2(10f, 10f), 5000, $"Exegesis-{ev.SourceId}", sa.Data.DefaultDangerColor);
                }
                break;
            case 15622:
                foreach (var pos in blocks15622)
                {
                    DrawHelper.DrawRectPosNoTarget(sa, pos, new Vector2(10f, 10f), 5000, $"Exegesis-{ev.SourceId}", sa.Data.DefaultDangerColor);
                }
                break;
            case 16988:
                foreach (var pos in blocks16988)
                {
                    DrawHelper.DrawRectPosNoTarget(sa, pos, new Vector2(10f, 10f), 5000, $"Exegesis-{ev.SourceId}", sa.Data.DefaultDangerColor);
                }
                break;
    ...
    [ScriptMethod(name: "Boss 2 Tower", eventType: EventTypeEnum.ObjectChanged, eventCondition: ["DataId:2009807"])]
    public void boss2Tower(Event ev, ScriptAccessory sa)
    {
        if (ev["Operate"] == "Add")
        {
            DrawHelper.DrawCircle(sa, ev.SourcePosition, new Vector2(5f), 7500, $"boss2Tower-{ev.SourceId}", sa.Data.DefaultSafeColor, scaleByTime: false);
        } else
        {
            sa.Method.RemoveDraw($"boss2Tower-{ev.SourceId}");
        }    
    }

    [ScriptMethod(name: "Perfect Contrition", eventType: EventTypeEnum.AddCombatant, eventCondition: ["DataId:10189"])]
    public void PerfectContrition(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawDount(sa, ev.SourcePosition, new Vector2(15f), new Vector2(5f), 7700, $"PerfectContrition-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha), scaleByTime: false);
    }
    ...
    [ScriptMethod(name: "AOE Notify Boss 3", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15636"])]
    ...
    [ScriptMethod(name: "Divine Diminuendo", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(15638|15640|15649)$"])]
    public void DivineDiminuendo(Event ev, ScriptAccessory sa)
    {
        switch (ev.ActionId)
        {
            case 15638 or 15649:
                {
                    var bytime = ev.ActionId == 15638;
                    DrawHelper.DrawCircle(sa, ev.EffectPosition, new Vector2(8f), 3700, $"Divine Diminuendo-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha), scaleByTime: bytime);
                    break;
                }
            case 15640:
                {
                    DrawHelper.DrawCircle(sa, ev.EffectPosition, new Vector2(8f), 3700, $"Divine Diminuendo-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha), scaleByTime: false);
                    DrawHelper.DrawDountObject(sa, ev.SourceId, new Vector2(16f), new Vector2(10f), 3700, $"Divine Diminuendo Second Donut-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha), scaleByTime: false);
                    DrawHelper.DrawDountObject(sa, ev.SourceId, new Vector2(32f), new Vector2(18f), 3700, $"Divine Diminuendo Second Donut-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha), scaleByTime: false);
                    break;
                }
        }
    }

    [ScriptMethod(name: "Conviction Marcato", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(15643|15642|15648)$"])]
    public void ConvictionMarcato(Event ev, ScriptAccessory sa)
    {
        DrawHelper.DrawRectObjectNoTarget(sa, ev.SourceId, new Vector2(5f, 40f), 3700, $"Conviction Marcato-{ev.SourceId}", new Vector4(1, 0, 0, ColorAlpha));
    }


    //[ScriptMethod(name: "Navi to Boss", eventType: EventTypeEnum.SetObjPos, eventCondition: ["SourceDataId:regex:^(10190)$"])]
    //public void Navi(Event ev, ScriptAccessory sa)
    //{
    //    if (isLead) DrawHelper.DrawDisplacement(sa, ev.SourcePosition, new Vector2(2f), 4700, $"Navi-{ev.SourceId}", sa.Data.DefaultSafeColor);
    //}
