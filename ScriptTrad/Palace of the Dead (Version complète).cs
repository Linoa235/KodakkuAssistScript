...
[ScriptType(name: "Palace of the Dead (Version complète, guid: "021ebfef-188a-401d-a16d-c2c9e1c2ce55")", territorys: [], $194c9fbf1-8b90-498a-83bf-59d5e88b1622", version: "0.0.0.1", Author: "Linoa235")]
...
public class the_Palace_of_the_Dead
{
    ...
    {
        if (isDebug) accessory.Log.Debug($"Script {Name} v{Version}{DebugVersion} initialized.");
