...
namespace CicerosKodakkuAssist.FuturesRewrittenUltimate
{
    ...
    [ScriptType(name: "Karlin's Eden Ultimate Script (Spirit Sight Modified Edition) wotou modified for personal use",
        territorys: [1238],
        guid: "42afdfd9-d75a-4fd5-b3ee-5f2f25a39757",
        version: "0.0.1.50",
    ...
    public class Futures_Rewritten_Ultimate
    {
        private const string UpdateInfo =
            """
            .34 version updated p5 floor fire and green player movement for gun shield (untested so disabled by default). To enable, go to settings and turn off bmr ai to avoid conflicts
            """;
        ...
        ***** è¯·åœ¨ä½¿ç”¨æ­¤è„šæœ¬å‰ä»”ç»†é˜…è¯»æ­¤å¤„çš„è¯´æ˜Ž! *****
        ...
        [UserSetting("Weird Mode (Some random weird prompts after each wipe.)")]
        public Weird_Shenanigans Weird_Shenanigan { get; set; } = Weird_Shenanigans.Astesia_ACR_XieXie_ACR;
        ...
        public Phase1_Standby_Positions_Of_Utopian_Sky Phase1_Standby_Position_Of_Utopian_Sky { get; set; } = Phase1_Standby_Positions_Of_Utopian_Sky.Swap_OT_And_M2_Swap_OT_And_D4_Moglin_Meow_And_MMW;
        [UserSetting("P1 Utopian Sky Mark Players In Safe Positions (Make sure only one in the party enables this!)")]
        ...
        public Phase1_Groups_Of_Turn_Of_The_Heavens Phase1_Group_Of_Turn_Of_The_Heavens { get; set; } = Phase1_Groups_Of_Turn_Of_The_Heavens.MTOTH1H2_Go_North_MTM1_vary_MTSTH1H2_Go_North_MTD1_Swap_Moglin_Meow_And_MMW;
        [UserSetting("P1 Fall Of Faith Strat")]
        public Phase1_Strats_Of_Fall_Of_Faith Phase1_Strat_Of_Fall_Of_Faith { get; set; } = Phase1_Strats_Of_Fall_Of_Faith.Single_Line_In_HTD_Order_By_HTD_Order_Moglin_Meow;
        [UserSetting("P1 Fall Of Faith Mark Players (Make sure only one in the party enables this!)")]
        public bool Phase1_Mark_Players_During_Fall_Of_Faith { get; set; } = false;
        [UserSetting("P1 Fall Of Faith Orientation Benchmark")]
        public Phase1_Orientation_Benchmarks_During_Fall_Of_Faith Phase1_Orientation_Benchmark_During_Fall_Of_Faith { get; set; } = Phase1_Orientation_Benchmarks_During_Fall_Of_Faith.High_Priority_Left_Facing_The_Boss_High_Priority_Left_Facing_The_Boss_Moglin_Meow_And_MMW;
        [UserSetting("P1 Towers Strat")]
        public Phase1_Strats_Of_Towers Phase1_Strat_Of_Towers { get; set; } = Phase1_Strats_Of_Towers.Completely_Based_On_Priority_Completely_Based_On_Priority_Moglin_Meow;

        [UserSetting("----- Phase 2 Settings ----- (No actual meaning for this setting)")]
        public bool _____Phase2_Settings_____ { get; set; } = true;
        [UserSetting("P2 Diamond Dust Strat After Knockback")]
        public Phase2_Strats_After_Knockback Phase2_Strat_After_Knockback { get; set; } = Phase2_Strats_After_Knockback.Clockwise_Both_Groups_Counterclockwise_Always_Clockwise_Both_Groups_Counterclockwise_Moglin_Meow_And_MMW;
        [UserSetting("P2 Mirror Mirror Strat")]
        public Phase2_Strats_Of_Mirror_Mirror Phase2_Strat_Of_Mirror_Mirror { get; set; } = Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Closest_Red_Right_If_Same_Melee_Group_Closest_Red_Mirror_Right_If_Same_Moglin_Meow_And_MMW;
        [UserSetting("P2 Mirror Mirror Rough Guidance Colour")]
        public ScriptColor Phase2_Colour_Of_Mirror_Rough_Guidance { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P2 Mirror Mirror Potential Dangerous Zones Colour")]
        ...
        public Phase2_Initial_Protean_Positions_Of_Light_Rampant Phase2_Initial_Protean_Position_Of_Light_Rampant { get; set; } = Phase2_Initial_Protean_Positions_Of_Light_Rampant.Normal_Protean_Tanks_North_East_For_Both_Grey9_Normal_Protean_Tanks_North_East_For_Grey9;
        [UserSetting("P2 Light Rampant Strat")]
        public Phase2_Strats_Of_Light_Rampant Phase2_Strat_Of_Light_Rampant { get; set; } = Phase2_Strats_Of_Light_Rampant.New_Grey9_New_Grey9_Moglin_Meow_And_MMW;
        [UserSetting("P2 Light Rampant Rough Paths Colour")]
        public ScriptColor Phase2_Colour_Of_Rough_Paths { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P2 Light Rampant Sphere AOEs Colour")]
        ...
        public Phase3_Strats_Of_The_First_Half Phase3_Strat_Of_The_First_Half { get; set; } = Phase3_Strats_Of_The_First_Half.Moogle_Moogle_Moglin_Meow_And_MMW;
        [UserSetting("P3 Green Player Auto-Movement")]
        public bool Phase3_Auto_Moving { get; set; } = true;
        [UserSetting("P3 Auto Face Lamp After Stun")]
        public bool Phase3_Auto_FaceLamp{ get; set; } = true;
        [UserSetting("P3 Second Half Strat")]
        public Phase3_Strats_Of_The_Second_Half Phase3_Strat_Of_The_Second_Half { get; set; } = Phase3_Strats_Of_The_Second_Half.Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs_Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs;
        [UserSetting("P3 Double Group Strat Branch")]
        public Phase3_Branches_Of_The_Double_Group_Strat Phase3_Branch_Of_The_Double_Group_Strat { get; set; } = Phase3_Branches_Of_The_Double_Group_Strat.Based_On_Safe_Positions_Based_On_Safe_Positions_MMW;
        [UserSetting("P3 Locomotive Strat Branch")]
        public Phase3_Branches_Of_The_Locomotive_Strat Phase3_Branch_Of_The_Locomotive_Strat { get; set; } = Phase3_Branches_Of_The_Locomotive_Strat.Others_As_Locomotives_Chinese_PF_Others_As_Locomotives_Chinese_PF;
        [UserSetting("P3 Second Half Zone Division")]
        public Phase3_Divisions_Of_The_Zone Phase3_Division_Of_The_Zone { get; set; } = Phase3_Divisions_Of_The_Zone.North_To_Southwest_For_The_Left_Group_North_To_Southwest_For_The_Left_Group_Moglin_Meow_And_MMW;
        [UserSetting("P3 Second Half Rough Guidance Colour")]
        public ScriptColor Phase3_Colour_Of_Rough_Guidance { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P3 Second Half Penultimate Apocalypse Colour")]
        public ScriptColor Phase3_Colour_Of_The_Penultimate_Apocalypse { get; set; } = new() { V4 = new(0, 1f, 1f, 1f) };
        [UserSetting("P3 Second Half Tank Who Baits Darkest Dance")]
        public Tanks Phase3_Tank_Who_Baits_Darkest_Dance { get; set; }
        [UserSetting("P3 Second Half Darkest Dance Colour")]
        ...
        [UserSetting("P4 First Half Water Stack Swap Method")]
        public Phase4_Strats_Of_The_First_Half Phase4_Strat_Of_The_First_Half { get; set; } = Phase4_Strats_Of_The_First_Half.Single_Swap_Baiting_After_Single_Swap_Then_Bait_Moglin_Meow_And_MMW;
        [UserSetting("P4 First Half Somber Dance Colour")]
        public ScriptColor Phase4_Colour_Of_Somber_Dance { get; set; } = new() { V4 = new(1f, 0f, 0f, 1f) };
        [UserSetting("P4 Second Half Mark Players (Make sure only one in the party enables this!)")]
        public bool Phase4_Mark_Players_During_The_Second_Half { get; set; } = false;
        [UserSetting("P4 Second Half Player Types To Be Marked")]
        public Phase4_Player_Types_To_Be_Marked Phase4_Player_Type_To_Be_Marked { get; set; }
        [UserSetting("P4 Second Half Wyrmclaw (Red) Player Priority")]
        public Phase4_Priorities_Of_The_Players_With_Wyrmclaw Phase4_Priority_Of_The_Players_With_Wyrmclaw { get; set; } = Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_THD_Order_By_THD_Order_Moglin_Meow;
        [UserSetting("P4 Second Half Logic For Marking Teammates With Wyrmclaw")]
        public Phase4_Logics_Of_Marking_Teammates_With_Wyrmclaw Phase4_Logic_Of_Marking_Teammates_With_Wyrmclaw { get; set; } = Phase4_Logics_Of_Marking_Teammates_With_Wyrmclaw.Ignore1_And_Bind1_Go_West_Ignore1_And_Bind1_Go_West_Moglin_Meow;
        [UserSetting("P4 Second Half Logic For Marking Teammates With Wyrmfang")]
        public Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang { get; set; }
        [UserSetting("P4 Second Half Display Duration Of Normal And Delayed Lights (seconds)")]
        public float Phase4_Drawing_Duration_Of_Normal_And_Delayed_Lights { get; set; } = 3f;
        [UserSetting("P4 Second Half Tidal Light Colour")]
        public ScriptColor Phase4_Colour_Of_Tidal_Light { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P4 Second Half Position Before Knockback")]
        public Phase4_Positions_Before_Knockback Phase4_Position_Before_Knockback { get; set; } = Phase4_Positions_Before_Knockback.Normal_Normal_Moglin_Meow_And_MMW;
        [UserSetting("P4 Second Half Residue Guidance Logic")]
        public Phase4_Logics_Of_Residue_Guidance Phase4_Logic_Of_Residue_Guidance { get; set; } = Phase4_Logics_Of_Residue_Guidance.According_To_Signs_On_Me_According_To_Signs_On_Me_Moglin_Meow_And_MMW;
        [UserSetting("P4 Second Half Residue Guidance Colour")]
        public ScriptColor Phase4_Colour_Of_Residue_Guidance { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P4 Second Half Attack1's Residue (Sign Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Attack1 { get; set; } = Phase4_Relative_Positions_Of_Residues.Eastmost_Eastmost;
        [UserSetting("P4 Second Half Attack2's Residue (Sign Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Attack2 { get; set; } = Phase4_Relative_Positions_Of_Residues.About_East_About_East;
        [UserSetting("P4 Second Half Attack3's Residue (Sign Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Attack3 { get; set; } = Phase4_Relative_Positions_Of_Residues.About_West_About_West;
        [UserSetting("P4 Second Half Attack4's Residue (Sign Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Attack4 { get; set; } = Phase4_Relative_Positions_Of_Residues.Westmost_Westmost;
        [UserSetting("P4 Second Half Dark Eruption's Residue (Debuff Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Dark_Eruption { get; set; } = Phase4_Relative_Positions_Of_Residues.Eastmost_Eastmost;
        [UserSetting("P4 Second Half Unholy Darkness's Residue (Debuff Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Unholy_Darkness { get; set; } = Phase4_Relative_Positions_Of_Residues.About_East_About_East;
        [UserSetting("P4 Second Half Dark Blizzard III's Residue (Debuff Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Dark_Blizzard_III { get; set; } = Phase4_Relative_Positions_Of_Residues.About_West_About_West;
        [UserSetting("P4 Second Half Dark Water III's Residue (Debuff Setting)")]
        public Phase4_Relative_Positions_Of_Residues Phase4_Residue_Belongs_To_Dark_Water_III { get; set; } = Phase4_Relative_Positions_Of_Residues.Westmost_Westmost;
        [UserSetting("P4 Second Half Drachen Wanderer Hitbox Length (meters)")]
        public float Phase4_Length_Of_Drachen_Wanderer_Hitboxes { get; set; } = 1.5f;
        [UserSetting("P4 Second Half Drachen Wanderer Hitbox Colour")]
        ...
        [UserSetting("P5 Fulgent Blade Colour")]
        public ScriptColor Phase5_Colour_Of_Fulgent_Blade { get; set; } = new() { V4 = new(0, 1f, 1f, 1f) };
        [UserSetting("P5 Fulgent Blade Current Guidance Step Colour")]
        public ScriptColor Phase5_Colour_Of_The_Current_Guidance_Step { get; set; } = new() { V4 = new(0f, 1f, 0f, 1f) };
        [UserSetting("P5 Fulgent Blade Next Guidance Step Colour")]
        public ScriptColor Phase5_Colour_Of_The_Next_Guidance_Step { get; set; } = new() { V4 = new(1f, 1f, 0f, 1f) };
        [UserSetting("P5 Fulgent Blade Boss Central Axis Colour")]
        public ScriptColor Phase5_Colour_Of_The_Boss_Central_Axis { get; set; } = new() { V4 = new(1f, 0f, 0f, 1f) };
        [UserSetting("P5 Fulgent Blade Boss Faces Players After")]
        public bool Phase5_Boss_Faces_Players_After_Fulgent_Blade { get; set; } = true;
        [UserSetting("P5 Green Player Auto-Movement (If enabling this, please turn off BMR AI)")]
        public bool Phase5_Auto_Moving { get; set; } = true;
        [UserSetting("P5 Light/Dark Stack Follow MT")]
        public bool Phase5_Follow_Mt { get; set; } = true;
        [UserSetting("P5 Wings Dark And Light Strat")]
        public Phase5_Strats_Of_Wings_Dark_And_Light Phase5_Strat_Of_Wings_Dark_And_Light { get; set; } = Phase5_Strats_Of_Wings_Dark_And_Light.Grey9_Brain_Dead_MT_First_Tower_Opposite_Grey9_Brain_Dead_MT_First_Tower_Opposite_Moglin_Meow_And_MMW;
        [UserSetting("P5 Wings Dark And Light Grey9 Brain Dead Strat Branch")]
        public Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat Phase5_Branch_Of_The_Grey9_Brain_Dead_Strat { get; set; } = Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat.Healers_First_Then_Melees_Left_Ranges_Right_Healers_First_Then_Melees_Left_Ranges_Right_Moglin_Meow;
        [UserSetting("P5 Wings Dark And Light Reverse Triangle Strat Branch")]
        public Phase5_Branches_Of_The_Reverse_Triangle_Strat Phase5_Branch_Of_The_Reverse_Triangle_Strat { get; set; }
        [UserSetting("P5 Wings Dark And Light Provoke Reminder")]
        public bool Phase5_Reminder_To_Provoke_During_Wings_Dark_And_Light { get; set; } = true;
        [UserSetting("P5 Polarizing Strikes Order")]
        public Phase5_Orders_During_Polarizing_Strikes Phase5_Order_During_Polarizing_Strikes { get; set; } = Phase5_Orders_During_Polarizing_Strikes.Tanks_Melees_Ranges_Healers_Tanks_Melees_Ranges_Healers_Moglin_Meow_And_MMW;
        ...
        readonly Object P1FogDragonCountReadWriteLock_AsAConstant = new Object();
        int P1FogDragonCount2 = 0;
        readonly Object P1FogDragonCount2ReadWriteLock_AsAConstant = new Object();
        List<int> P1FogDragonRecord = new List<int>{0, 0, 0, 0};
        ...
        List<int> P1TurnOfHeavensTether = [0, 0, 0, 0, 0, 0, 0, 0];
        ...
        public enum Phase1_Standby_Positions_Of_Utopian_Sky
        {
            ...
            Swap_OT_And_M2_Swap_OT_And_D4_Moglin_Meow_And_MMW,
        ...
        public enum Phase1_Groups_Of_Turn_Of_The_Heavens
        {
            ...
            MTOTH1H2_Go_North_MTM1_vary_MTSTH1H2_Go_North_MTD1_Swap_Moglin_Meow_And_MMW,
            MTH1M1R1_Go_North_MTOT_vary_MTH1D1D3_Go_North_MTST_Swap,
            MTOTR1R2_Go_North_MTM1_vary_MTSTD3D4_Go_North_MTD1_Swap_Moglin_Meow
        ...
        public enum Phase1_Strats_Of_Fall_Of_Faith
        {
            ...
            Single_Line_In_THD_Order_By_THD_Order,
            Single_Line_In_HTD_Order_By_HTD_Order_Moglin_Meow,
            Single_Line_In_H1TDH2_Order_By_H1TDH2_Order,
            Double_Lines_H12MOT_Left_M12R12_Right_Double_Lines_Left_H12MST_Right_D1234_Moglin_Meow_And_MMW,
            Double_Lines_MOTH12_Left_M12R12_Right_Double_Lines_Left_MSTH12_Right_D1234
        ...
        public enum Phase1_Orientation_Benchmarks_During_Fall_Of_Faith
        {
            ...
            High_Priority_Left_Facing_Due_North_High_Priority_Left_Facing_Due_North,
            High_Priority_Left_Facing_The_Boss_High_Priority_Left_Facing_The_Boss_Moglin_Meow_And_MMW
        ...
        public enum Phase1_Strats_Of_Towers
        {
            ...
            Completely_Based_On_Priority_Completely_Based_On_Priority_Moglin_Meow,
            Fixed_H1H2R2_Priority_For_Rest_Fixed_H1H2D4_Priority_For_Rest,
            Fixed_H1H2R2_Rest_Fill_Vacancies_Fixed_H1H2D4_Rest_Fill_Vacancies_MMW
        ...
        public enum Phase2_Strats_After_Knockback
        {
            ...
            Clockwise_One_Group_Counterclockwise_Always_Clockwise_One_Group_Counterclockwise,
            Counterclockwise_One_Group_Clockwise_Always_Counterclockwise_One_Group_Clockwise,
            Clockwise_Both_Groups_Counterclockwise_Always_Clockwise_Both_Groups_Counterclockwise_Moglin_Meow_And_MMW,
            Counterclockwise_Both_Groups_Clockwise_Always_Counterclockwise_Both_Groups_Clockwise
        ...
        public enum Phase2_Strats_Of_Mirror_Mirror
        {
            ...
            Melee_Group_Left_Red_Melee_Group_Go_Left_Red_Mirror,
            Melee_Group_Right_Red_Melee_Group_Go_Right_Red_Mirror,
            Melee_Group_Closest_Red_Left_If_Same_Melee_Group_Closest_Red_Mirror_Left_If_Same,
            Melee_Group_Closest_Red_Right_If_Same_Melee_Group_Closest_Red_Mirror_Right_If_Same_Moglin_Meow_And_MMW
        ...
        public enum Phase2_Initial_Protean_Positions_Of_Light_Rampant
        {
            ...
            Supporters_North_MOTH12_For_JPPF_And_L_Supporters_All_North_MSTH12_For_JPPF_And_L,
            Supporters_North_H12MOT_For_JPPF_And_L_Supporters_All_North_H12MST_For_JPPF_And_L,
            Normal_Protean_Tanks_North_East_For_Both_Grey9_Normal_Protean_Tanks_North_East_For_Grey9
        ...
        public enum Phase2_Strats_Of_Light_Rampant
        {
            ...
            Star_Of_David_Japanese_PF_Star_Of_David_Japanese_PF_Moglin_Meow_And_MMW,
            New_Grey9_New_Grey9_Moglin_Meow_And_MMW,
            Lucrezia_L_Strat,
            Obsolete_Old_Grey9_Obsolete_Old_Grey9_Moglin_Meow
        ...
        public enum Phase3_Strats_Of_The_First_Half
        {
            ...
            Moogle_Moogle_Moglin_Meow_And_MMW,
        ...
        public enum Phase3_Strats_Of_The_Second_Half
        {
            ...
            Double_Group,
            High_Priority_As_Locomotives_Locomotive_Strat_MMW,
            Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs_Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs
        ...
        public enum Phase3_Branches_Of_The_Double_Group_Strat
        {
            ...
            Based_On_Safe_Positions_Based_On_Safe_Positions_MMW,
            Based_On_The_Second_Apocalypse_Based_On_The_Second_Apocalypse
        ...
        public enum Phase3_Branches_Of_The_Locomotive_Strat
        {
            ...
            MT_And_M1_As_Locomotives_MT_And_D1_As_Locomotives_MMW,
            Others_As_Locomotives_Chinese_PF_Others_As_Locomotives_Chinese_PF
        ...
        public enum Phase3_Divisions_Of_The_Zone
        {
            ...
            North_To_Southwest_For_The_Left_Group_North_To_Southwest_For_The_Left_Group_Moglin_Meow_And_MMW,
            Northwest_To_South_For_The_Left_Group_Northwest_To_South_For_The_Left_Group
        ...
        public enum Phase4_Strats_Of_The_First_Half
        {
            ...
            Single_Swap_Baiting_After_Single_Swap_Then_Bait_Moglin_Meow_And_MMW,
            Single_Swap_Baiting_First_Bait_Then_Single_Swap,
            Double_Swaps_Baiting_First_Bait_Then_Double_Swaps

        }

        public enum Phase4_Player_Types_To_Be_Marked {
            
            Both_The_Debuffs_Wyrmclaw_And_Wyrmfang_Mark_Both_Wyrmclaw_And_Wyrmfang,
            Only_Wyrmclaw_The_Red_Debuff_Mark_Only_Wyrmclaw_Red_Debuff,
            Only_Wyrmfang_The_Blue_Debuff_Mark_Only_Wyrmfang_Blue_Debuff
        ...
        public enum Phase4_Priorities_Of_The_Players_With_Wyrmclaw
        {
            ...
            In_THD_Order_By_THD_Order_Moglin_Meow,
            In_HTD_Order_By_HTD_Order_MMW,
            In_H1TDH2_Order_By_H1TDH2_Order

        }

        public enum Phase4_Logics_Of_Marking_Teammates_With_Wyrmclaw {
            
            Ignore1_And_Bind1_Go_West_Ignore1_And_Bind1_Go_West_Moglin_Meow,
            Ignore1_And_Ignore2_Go_West_Ignore1_And_Ignore2_Go_West
        ...
        public enum Phase4_Logics_Of_Residue_Guidance
        {
            ...
            According_To_Signs_On_Me_According_To_Signs_On_Me_Moglin_Meow_And_MMW,
            According_To_Debuffs_According_To_Debuffs
        ...
        public enum Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang
        {
            ...
            According_To_Debuffs_1234_From_East_To_West_According_To_Debuffs_1234_From_East_To_West,
            According_To_Debuffs_1342_From_East_To_West_According_To_Debuffs_1342_From_East_To_West,
            According_To_The_Priority_THD_According_To_THD_Priority,
            According_To_The_Priority_HTD_According_To_HTD_Priority,
            According_To_The_Priority_H1TDH2_According_To_H1TDH2_Priority
        ...
        public enum Phase4_Positions_Before_Knockback
        {
            ...
            Normal_Normal_Moglin_Meow_And_MMW,
            Y_Formation_Japanese_PF_Y_Formation_Japanese_PF
        ...
        public enum Phase5_Strats_Of_Wings_Dark_And_Light
        {
            ...
            Grey9_Brain_Dead_MT_First_Tower_Opposite_Grey9_Brain_Dead_MT_First_Tower_Opposite_Moglin_Meow_And_MMW,
            Reverse_Triangle_MT_Baits_In_Towers_Reverse_Triangle_MT_Baits_In_Towers
        ...
        public enum Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat
        {
            ...
            Healers_First_Then_Melees_Left_Ranges_Right_Healers_First_Then_Melees_Left_Ranges_Right_Moglin_Meow,
            Melees_First_Then_Healers_Left_Ranges_Right_Melees_First_Then_Healers_Left_Ranges_Right,
            Healer_First_Then_Melees_Farther_Ranges_Closer_Healer_First_Then_Melees_Farther_Ranges_Closer_MMW
        ...
        public enum Phase5_Branches_Of_The_Reverse_Triangle_Strat
        {
            ...
            Healers_First_Then_Melees_Left_Ranges_Right_Healers_First_Then_Melees_Left_Ranges_Right,
            Melees_First_Then_Healers_Left_Ranges_Right_Melees_First_Then_Healers_Left_Ranges_Right
        ...
        public enum Phase5_Orders_During_Polarizing_Strikes
        {
            ...
            Tanks_Melees_Ranges_Healers_Tanks_Melees_Ranges_Healers_Moglin_Meow_And_MMW,
            Tanks_Healers_Melees_Ranges_Tanks_Healers_Melees_Ranges
        ...
        public void Init(ScriptAccessory accessory)
        {
            ...
            P1FogDragonRecord = new List<int>{0, 0, 0, 0};
            P1FogDragonCount = 0;
            P1FogDragonCount2 = 0;
            P1TurnOfHeavensTether = [0, 0, 0, 0, 0, 0, 0, 0];
            ...
            resetPoints();//Initialize floor fire coordinates
        }
        ...
        public void Weird_Shenanigans_Func(Event @event, ScriptAccessory accessory) {
            ...
            if(Weird_Shenanigan==Weird_Shenanigans.Astesia_ACR_XieXie_ACR) {
                ...
                if(randomNumber<=25) {
                    ...
                    if(Language_Of_Prompts==Languages_Of_Prompts.Simplified_Chinese) {
                        ...
                        prompt="Welcome to using Piggy Xie Xie's ACR!";
                    ...
                    if(Language_Of_Prompts==Languages_Of_Prompts.Simplified_Chinese) {
                        ...
                        prompt="Welcome to using Xie Xie (Astesia)'s ACR!";
            ...
            if(Weird_Shenanigan==Weird_Shenanigans.Res_Gestae_Populi_Romani_II_Bellum_Hannibalicum) {
                ...
                List<string> chineseContents=[
                    "First Punic War:\nRome and Carthage fought their first large-scale land and naval battle for control of Sicily. The Roman navy nearly annihilated the Carthaginian fleet in its debut, ultimately Rome won and seized Sicily.",
                    "After the First Punic War:\nCarthage turned to expansion in Spain to compensate for losses. Hannibal, son of Carthaginian general Hamilcar from the First Punic War, the legendary commander, appeared.",
                    "Early Second Punic War:\nCarthage initiated the Second Punic War. Hannibal led his army miraculously across Gaul and the Alps, severely crushing and repeatedly annihilating Roman forces. Rome was utterly defeated at Cannae.",
                    "Mid-Second Punic War Part I:\nHannibal won repeatedly in Italy but failed to take Rome. Rome's counteroffensive in Spain was crushed. At the Republic's moment of life and death, Scipio volunteered to the Senate. Rome's legendary commander appeared.",
                    "Mid-Second Punic War Part II:\nScipio achieved successive victories in Spain, annihilating two Carthaginian armies against odds. Hannibal's reinforcements entering Italy were intercepted and annihilated. Rome retook all major city-states in southern Italy.",
                    "Late Second Punic War:\nScipio landed in North Africa and controlled Numidia. Hannibal was recalled to his homeland by the Carthaginian Council of Elders. In the epic Battle of Zama, the two generals faced off. Scipio used tactics created by Hannibal to annihilate Hannibal's army. Rome won decisively.",
                    "After the Punic Wars:\nScipio was framed by political rival Cato, resigned and retired, soon dying of illness, \"Ungrateful homeland does not deserve my bones\". Hannibal fled to Hellenized Phoenician city-states, then committed suicide by poison in Asia Minor before being caught up by Roman pursuers.",
                    "Fall of Macedon:\nRome defeated the Kingdom of Macedon in the Third Macedonian War and dissolved it, conquering Greece and achieving hegemony over the Mediterranean.",
                    "Fall of Carthage:\nRome launched the Third Punic War. Carthage fell and completely ceased to exist. The Romans, looking over the Mediterranean, left a proud victor's declaration: \"Mare Nostrum (Our Sea)\"."
                ];
            ...
            if(Weird_Shenanigan==Weird_Shenanigans.Call_Of_Duty_Death_Quotes) {
                ...
                List<string> chineseContents=[
                    ...
                    "Above the graves, the wind howls.",
                    "The enslaved were not bricks paving your road, nor were their lives chapters in your history of redemption.",
                    ...
                    "The living are not guests of honor, yet the dead become occupants of coffins.",
                    "All who draw the sword will die by the sword.",
                    "Injustice anywhere is a threat to justice everywhere.",
                    "I die without seeing the dawn illuminate my homeland.",
                    "I was born into a kind world and loved it with all my heart. I die in an evil world, with nothing to say in farewell.",
                    "You cannot raise a person with pain, nor can you satisfy their hunger with anger.",
                    "\"We have passed!\"",
                    "The bison is slaughtered, the villagers feast on its remains.",
                    "Those who play with fire will eventually realize that the sensation of burning accompanies the warmth.",
                    "A mansion built on shifting sand is bound to collapse.",
                    "The faithful and honest shall be abundantly blessed.",
                    "She smiled sadly and vanished into the endless night sky.",
                    "Only death marks the end of duty.",
                    "The end may justify the means, but something must justify the end.",
                    "Sing your death song and die like a hero returning home.",
                    "The mutineers ride their horses, disappearing into the night.",
                    "Historically, whenever people begin to believe that hypocritical respect for formal frameworks can replace genuine obedience to moral obligations, the bloodthirsty specter of brutality returns to the human realm.",
            ...
            if(Weird_Shenanigan==Weird_Shenanigans.StarCraft_SCBoy) {
                ...
                List<string> contents=[
                    "Hey, your ally's base is being flattened!",
                    "Your buddy is getting wrecked, aren't you going to help?",
                    "Your ally is in combat, are you just going to watch?",
                    "The base is under attack! Go check it out, will you?",
                    "The base is being hit! Time to base trade!", // 5
                    "Can't warp in units without a power field!",
                    "Nuke incoming! GG!",
                    "See that red dot? That's a nuke!",
                    "The enemy ignores you and throws a fusion core strike your way.",
                    "Base upgrade complete. That feels good!", // 10
                    "Your command center has been upgraded!",
                    "Five! Four! Three! Two! One! GG!",
                    "This upgrade is crucial and very timely.",
                    "Hey, fighting now? Show off those micro skills!",
                    "Your forces are taking massive damage!", // 15
                    "Your forces are engaging. What?",
                    "Hey hey, enemies are hitting your troops, buddy!",
                    "Your noble Protoss warriors are about to die!",
                    "Your Protoss forces are screaming in agony!",
                    "The enemy is using bug spray on you!", // 20
                    "Your Zerg swarm has been obliterated!",
                    "Pause the game.",
                    "Alright, I'm back!",
                    "Feeling like the gas is drained...",
                    "Something's in the way, need to clear the ground first. Get those APMs spiking!", // 25
                    "Can't land here, what are you thinking?",
                    "Hey, you're supply capped! Time to push!",
                    "Supply capped? Then just F2 A-move!",
                    "Mineral patches depleted. Do you have an expansion?",
                    "Zerg structures must be placed on Creep. You can find creep, right?", // 30
                    "I can't stand this. How to build without creep? Guess!",
                    "Supply low, your production is insane!",
                    "Please warp in more Pylons. Consider a proxy Pylon!",
                    "Nuclear weapon ready, kill them all!",
                    "Low on Minerals. Watch your spending, okay?", // 35
                    "Hey, low on ore! Being broke feels bad!",
                    "So sneaky, stealing our SCVs like that!",
                    "Why keep hitting our SCVs? You're asking for it!",
                    "Your SCV is under attack! This is a denial of living!",
                    "They're focusing down your Probe, situation critical!" // 40
                ];
        ...
        [ScriptMethod(name: "P1_ProteanFireLightning_GuideCone", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^((4014[48])|40329|40330)$"])]
        public void P1_ProteanFireLightning_GuideCone(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            ...
            foreach (var pm in accessory.Data.PartyList)
            {
                ...
                dp.Name = "P1_ProteanFireLightning_GuideCone";
                dp.Scale = new(60);
        ...
        [ScriptMethod(name: "P1_ProteanFireLightning_SubsequentCone", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:regex:^(40145)$", "TargetIndex:1"])]
        public void P1_ProteanFireLightning_SubsequentCone(Event @event, ScriptAccessory accessory)
        {
            var dur = 2000;
            if (parse!=1) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_ProteanFireLightning_SubsequentCone1";
            dp.Scale = new(60);
            dp.FixRotation = true;
            dp.Rotation = rot;
            dp.Radian = float.Pi / 8;
            ...
            dp.Name = "P1_ProteanFireLightning_SubsequentCone2";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 8;
            dp.FixRotation = true;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_ProteanFireLightning_SubsequentCone3";
            dp.Scale = new(60);
            dp.FixRotation = true;
        ...
        [ScriptMethod(name: "P1_ProteanFireLightning_SpreadStack", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^((4014[48])|40329|40330)$"])]
        public void P1_ProteanFireLightning_SpreadStack(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            string prompt = "";
            ...
            if (@event["ActionId"] == "40148" || @event["ActionId"] == "40330")
            {
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_ProteanFireLightning_Spread";
                    dp.Scale = new(6);
                    dp.Owner = pm;
                    dp.Color = accessory.Data.DefaultDangerColor;
                    dp.Delay = 5000;
            ...
            else
            {
                ...
                for (int i = 4; i <= 7; ++i)
                {
                    ...
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_ProteanFireLightning_Stack";
                    dp.Scale = new(6);
        ...
        [ScriptMethod(name: "P1_ProteanFireLightning_GuidePosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^((4014[48])|40329|40330)$"])]
        public void P1_ProteanFireLightning_GuidePosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            var myindex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_ProteanFireLightning_GuidePosition";
            dp.Scale = new(2);
        ...
        public void P1_TankBusterBuffExplosion(Event @event, ScriptAccessory accessory)
        {
               ...
               accessory.Data.PartyList.IndexOf(accessory.Data.Me) == 1)
            {
                ...
                if (Language_Of_Prompts == Languages_Of_Prompts.Simplified_Chinese)
                {
                    ...
                    prompt = "Get slightly closer to the other tank";
        ...
        [ScriptMethod(name: "P1_FogDragon_RecordPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40158)$"], userControl: false)]
        public void P1_FogDragon_RecordPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
        ...
        [ScriptMethod(name: "P1_FogDragon_RecordFireLightning", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:regex:^(4015[45])$"], userControl: false)]
        public void P1_FogDragon_RecordFireLightning(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
        ...
        public void Phase1_Standby_Position_Of_Utopian_Sky(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase1_Standby_Position_Of_Utopian_Sky == Phase1_Standby_Positions_Of_Utopian_Sky.Swap_OT_And_M2_Swap_OT_And_D4_Moglin_Meow_And_MMW)
            {
        ...
        [ScriptMethod(name: "P1_FogDragon_HandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40158)$"])]
        public void P1_FogDragon_HandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;

            lock (P1FogDragonCountReadWriteLock_AsAConstant)
            {
                P1FogDragonCount++;
                ...
                Task.Delay(334).ContinueWith(t =>
                {
                    if (!P1FogDragonThunder)
                    {
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FogDragon_StackHandlingPosition";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                        dp.TargetPosition = mPosEnd;
                        dp.ScaleMode |= ScaleMode.YByDistance;
                    ...
                    else
                    {
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FogDragon_SpreadHandlingPosition";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                        dp.TargetPosition = mPosEnd;
                        dp.ScaleMode |= ScaleMode.YByDistance;
        ...
        public void Phase1_Mark_Players_In_Safe_Positions(Event @event, ScriptAccessory accessory)
        {
            ...
            lock (P1FogDragonCount2ReadWriteLock_AsAConstant)
            {
                ...
                Task.Delay(334).ContinueWith(t =>
                {
                    ...
                    int safePositions = P1FogDragonRecord.IndexOf(0);
        ...
        [ScriptMethod(name: "P1-UtopianSky-HaloRange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(4015[23])$"])]
        public void P1_UtopianSky_HaloRange(Event evt, ScriptAccessory sa)
        {
            if (!ParseObjectId(@evt["SourceId"], out var sid)) return;
            //var sid = evt.SourceId();
            var delay = 4000;
            var dp = sa.Data.GetDefaultDrawProperties();
            dp.Name = "P1-UtopianSky-HaloRange";
            dp.Owner = sid;
        ...
        [ScriptMethod(name: "P1_TurnOfTheHeavens_RecordTethers", eventType: EventTypeEnum.StatusAdd, eventCondition: ["StatusID:4165"], userControl: false)]
        public void P1_TurnOfTheHeavens_RecordTethers(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            if (!ParseObjectId(@event["TargetId"], out var tid)) return;
            lock (this)
            {
                P1TurnOfHeavensTether[accessory.Data.PartyList.IndexOf(((uint)tid))] = 1;
            }
        }
        ...
        public void Phase1_Stack_Range_Of_Turn_Of_The_Heavens(Event @event, ScriptAccessory accessory)
        {
            ...
            int highPriorityStack = P1TurnOfHeavensTether.IndexOf(1);
            int lowPriorityStack = P1TurnOfHeavensTether.LastIndexOf(1);
            List<int> membersOfTheNorthGroup = [];

            if (Phase1_Group_Of_Turn_Of_The_Heavens == Phase1_Groups_Of_Turn_Of_The_Heavens.MTOTH1H2_Go_North_MTM1_vary_MTSTH1H2_Go_North_MTD1_Swap_Moglin_Meow_And_MMW)
            {
            ...
            if (Phase1_Group_Of_Turn_Of_The_Heavens == Phase1_Groups_Of_Turn_Of_The_Heavens.MTH1M1R1_Go_North_MTOT_vary_MTH1D1D3_Go_North_MTST_Swap)
            {
            ...
            if (Phase1_Group_Of_Turn_Of_The_Heavens == Phase1_Groups_Of_Turn_Of_The_Heavens.MTOTR1R2_Go_North_MTM1_vary_MTSTD3D4_Go_North_MTD1_Swap_Moglin_Meow)
            {
        ...
        [ScriptMethod(name: "P1_TurnOfTheHeavens_KnockbackHandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40152)$"])]
        public void P1_TurnOfTheHeavens_KnockbackHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            //dy 7
            if (parse!=1) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            ...
            var o1 = P1TurnOfHeavensTether.IndexOf(1);
            var o2 = P1TurnOfHeavensTether.LastIndexOf(1);
            List<int> upGroup = [];
            if (Phase1_Group_Of_Turn_Of_The_Heavens == Phase1_Groups_Of_Turn_Of_The_Heavens.MTOTH1H2_Go_North_MTM1_vary_MTSTH1H2_Go_North_MTD1_Swap_Moglin_Meow_And_MMW)
            {
                upGroup.Add(o1);
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_TurnOfTheHeavens_KnockbackHandlingPosition1";
            dp.Scale = new(2);
            dp.Owner = accessory.Data.Me;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_TurnOfTheHeavens_KnockbackHandlingPosition2";
            dp.Scale = new(2);
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P1_TurnOfTheHeavens_KnockbackHandlingPosition3";
            dp.Scale = new(2);
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos2;
            dp.ScaleMode |= ScaleMode.YByDistance;
        ...
        public void Phase1_Mark_Untethered_Players(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase1_Strat_Of_Fall_Of_Faith == Phase1_Strats_Of_Fall_Of_Faith.Single_Line_In_THD_Order_By_THD_Order
               ||
               Phase1_Strat_Of_Fall_Of_Faith == Phase1_Strats_Of_Fall_Of_Faith.Double_Lines_MOTH12_Left_M12R12_Right_Double_Lines_Left_MSTH12_Right_D1234)
            {
            ...
            if (Phase1_Strat_Of_Fall_Of_Faith == Phase1_Strats_Of_Fall_Of_Faith.Single_Line_In_HTD_Order_By_HTD_Order_Moglin_Meow
               ||
               Phase1_Strat_Of_Fall_Of_Faith == Phase1_Strats_Of_Fall_Of_Faith.Double_Lines_H12MOT_Left_M12R12_Right_Double_Lines_Left_H12MST_Right_D1234_Moglin_Meow_And_MMW)
            {
            ...
            if (Phase1_Strat_Of_Fall_Of_Faith == Phase1_Strats_Of_Fall_Of_Faith.Single_Line_In_H1TDH2_Order_By_H1TDH2_Order)
            {
                // The addition of this strat credits to @alexandria_prime. Appreciate!
        ...
        [ScriptMethod(name: "P1_FourTethers_HandlingPosition", eventType: EventTypeEnum.Tether, eventCondition: ["Id:regex:^(00F9|011F)$"])]
        public void P1_FourTethers_HandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (!phase1_isInFallOfFaith) return;
            if (!ParseObjectId(@event["TargetId"], out var tid)) return;
            var dis = 2.5f;//distance from named person
            ...
            Task.Delay(334).ContinueWith(t =>
            {
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether1HandlingPosition1";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether1HandlingPosition2";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    {
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FourTethers_Tether1HandlingPosition2Preview";
                        dp.Scale = new(2);
                        dp.Position = t1p1;
                        dp.TargetPosition = t1p2;
                        dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether2HandlingPosition1";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether2HandlingPosition2";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    {
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FourTethers_Tether2HandlingPosition2Preview";
                        dp.Scale = new(2);
                        dp.Position = t2p1;
                        dp.TargetPosition = t2p2;
                        dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether3HandlingPosition1";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether3HandlingPosition2";
                    dp.Scale = new(3);
                    dp.Owner = accessory.Data.Me;
                    ...
                    {
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FourTethers_Tether3HandlingPosition2Preview";
                        dp.Scale = new(2);
                        dp.Position = t3p1;
                        dp.TargetPosition = t3p2;
                        dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether4HandlingPosition1";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_Tether4HandlingPosition2";
                    dp.Scale = new(3);
                    dp.Owner = accessory.Data.Me;
                    ...
                    {
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FourTethers_Tether4HandlingPosition2Preview";
                        dp.Scale = new(2);
                        dp.Position = t4p1;
                        dp.TargetPosition = t4p2;
                        dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                if (phase1_tetheredPlayersDuringFallOfFaith.Count == 4)
                {
                    ...
                    if (Phase1_Orientation_Benchmark_During_Fall_Of_Faith == Phase1_Orientation_Benchmarks_During_Fall_Of_Faith.High_Priority_Left_Facing_Due_North_High_Priority_Left_Facing_Due_North)
                    {
                    ...
                    if (Phase1_Orientation_Benchmark_During_Fall_Of_Faith == Phase1_Orientation_Benchmarks_During_Fall_Of_Faith.High_Priority_Left_Facing_The_Boss_High_Priority_Left_Facing_The_Boss_Moglin_Meow_And_MMW)
                    {
                    ...
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_HandlingPosition1";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = dealpos1;
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P1_FourTethers_HandlingPosition2";
                    dp.Scale = new(2);
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = dealpos2;
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    ...
                    {
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FourTethers_HandlingPosition2Preview";
                        dp.Scale = new(2);
                        dp.Position = dealpos1;
                        dp.TargetPosition = dealpos2;
                        dp.ScaleMode |= ScaleMode.YByDistance;
        ...
        [ScriptMethod(name: "P1_Towers_TowerRecorder", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(4012[234567]|4013[15])$"], userControl: false)]
        public void P1_Towers_TowerRecorder(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            lock (this)
            {
        ...
        [ScriptMethod(name: "P1_Towers_TowerHandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40134|40129)$"])]
        public void P1_Towers_TowerHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=1) return;
            Task.Delay(334).ContinueWith(t =>
            {
                ...
                if (@event["ActionId"] == "40134")
                {
                    ...
                    if (myIndex == 0 || myIndex == 1)
                    {
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_ThunderTower_TowerHandlingPosition_T";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                    ...
                    else
                    {
                        ...
                        if (Phase1_Strat_Of_Towers == Phase1_Strats_Of_Towers.Completely_Based_On_Priority_Completely_Based_On_Priority_Moglin_Meow)
                        {
                        ...
                        if (Phase1_Strat_Of_Towers == Phase1_Strats_Of_Towers.Fixed_H1H2R2_Priority_For_Rest_Fixed_H1H2D4_Priority_For_Rest)
                        {
                        ...
                        if (Phase1_Strat_Of_Towers == Phase1_Strats_Of_Towers.Fixed_H1H2R2_Rest_Fill_Vacancies_Fixed_H1H2D4_Rest_Fill_Vacancies_MMW)
                        {
                            ...
                            if (!fixedPartyMember)
                            {
                                ...
                                if (Enable_Developer_Mode)
                                {
                                    ...
                                    accessory.Method.SendChat($"""
                                                               /e 
                                                               P1Towers[0]={P1Towers[0]}
                                                               P1Towers[1]={P1Towers[1]}
                                                               P1Towers[2]={P1Towers[2]}
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_ThunderTower_TowerHandlingPosition_ND";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                        ...
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_ThunderTower_Tower_ND";
                        dp.Scale = new(4);
                ...
                else
                {
                    ...
                    if (myIndex == 0 || myIndex == 1)
                    {
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FireTower_TowerHandlingPosition_T1";
                        ...
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FireTower_TowerHandlingPosition_T2";
                        dp.Scale = new(2);
                        ...
                        dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FireTower_TowerHandlingPosition_T3";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                        dp.TargetPosition = new(100 + dx2, 0, 100 + dy);
                        dp.ScaleMode |= ScaleMode.YByDistance;
                    ...
                    else
                    {
                        ...
                        var dp = accessory.Data.GetDefaultDrawProperties();
                        dp.Name = "P1_FireTower_TowerHandlingPosition_ND";
                        dp.Scale = new(2);
                        dp.Owner = accessory.Data.Me;
                        dp.TargetPosition = standbyPosition;
                        dp.ScaleMode |= ScaleMode.YByDistance;
        ...
        [ScriptMethod(name: "P2_PhaseChange", eventType: EventTypeEnum.Director, eventCondition: ["Instance:800375BF", "Command:8000001E"], userControl: false)]
        ...
        [ScriptMethod(name: "P2_DiamondDust_IronDonutRecord", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^((4020[23]))$"], userControl: false)]
        public void P2_DiamondDust_IronDonutRecord(Event @event, ScriptAccessory accessory)
        {
            P2DDPattern = (@event["ActionId"] == "40202");//Iron
        }
        [ScriptMethod(name: "P2_DiamondDust_IronDonut", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^((4020[23]))$"])]
        public void P2_DiamondDust_IronDonut(Event @event, ScriptAccessory accessory)
        {
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            if (@event["ActionId"] == "40202")//Iron
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P2_DiamondDust_Iron";
                dp.Scale = new(16);
                dp.Owner = sid;
                dp.Color = accessory.Data.DefaultDangerColor;
                dp.DestoryAt = 6000;
        ...
        [ScriptMethod(name: "P2_DiamondDust_IciclePlacementPosition", eventType: EventTypeEnum.TargetIcon)]
        public void P2_DiamondDust_IciclePlacementPosition(Event @event, ScriptAccessory accessory)
        {
            ...
            Vector3 epos1 = P2DDPattern ? new(119.5f, 0, 100.0f) : new(103.5f, 0, 100.0f);
            Vector3 epos2 = P2DDPattern ? new(119.5f, 0, 100.0f) : new(108.0f, 0, 100.0f);
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_DiamondDust_IciclePlacementPosition1";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos1;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_DiamondDust_IciclePlacementPosition2";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Position = dealpos1;
            dp.TargetPosition = dealpos2;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_DiamondDust_IciclePlacementPosition3";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos2;
        ...
        public void P2_DiamondDust_ConeGuidePosition(Event @event, ScriptAccessory accessory)
        {
            ...
            Vector3 epos = P2DDPattern ? new(116.5f, 0, 100f) : new(101f, 0, 100f);
        ...
        public void Phase2_Guidance_After_Knockback(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase2_Strat_After_Knockback == Phase2_Strats_After_Knockback.Clockwise_One_Group_Counterclockwise_Always_Clockwise_One_Group_Counterclockwise)
            {
            ...
            if (Phase2_Strat_After_Knockback == Phase2_Strats_After_Knockback.Counterclockwise_One_Group_Clockwise_Always_Counterclockwise_One_Group_Clockwise)
            {
            ...
            if (Phase2_Strat_After_Knockback == Phase2_Strats_After_Knockback.Clockwise_Both_Groups_Counterclockwise_Always_Clockwise_Both_Groups_Counterclockwise_Moglin_Meow_And_MMW)
            {
            ...
            if (Phase2_Strat_After_Knockback == Phase2_Strats_After_Knockback.Counterclockwise_Both_Groups_Clockwise_Always_Counterclockwise_Both_Groups_Clockwise)
            {
        ...
        [ScriptMethod(name: "P2_DiamondDust_BlastingZoneRange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^4019[34]$"])]
        public void P2_DiamondDust_BlastingZoneRange(Event @event, ScriptAccessory accessory)
        {
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            var time = 300;
            //93 front first
            ...
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P2_DiamondDust_BlastingZoneRangeFront1";
                dp.Scale = new(30);
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P2_DiamondDust_BlastingZoneRangeBack2";
                dp.Scale = new(30);
                dp.Radian = float.Pi / 2;
            ...
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P2_DiamondDust_BlastingZoneRangeBack1";
                dp.Scale = new(30);
                dp.Radian = float.Pi / 2;
                dp.Rotation = float.Pi;
                dp.Owner = sid;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P2_DiamondDust_BlastingZoneRangeFront2";
                dp.Scale = new(30);
                dp.Radian = float.Pi / 2 * 3;
                dp.Owner = sid;
                dp.Color = accessory.Data.DefaultDangerColor;
        ...
        [ScriptMethod(name: "P2_TwoMirrors_SpreadStack", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(4022[01])$"])]
        public void P2_TwoMirrors_SpreadStack(Event @event, ScriptAccessory accessory)
        {
            if (parse!=22) return;
            string prompt = "";
        ...
        [ScriptMethod(name: "P2_TwoMirrors_BlueMirrorDonutAndConeGuide", eventType: EventTypeEnum.EnvControl, eventCondition: ["DirectorId:800375BF", "State:00020001"])]
        public void P2_TwoMirrors_BlueMirrorDonutAndConeGuide(Event @event, ScriptAccessory accessory)
        {
            if (parse!=22) return;
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_BlueMirrorDonut";
            dp.Scale = new(20);
            dp.InnerScale = new(4);
            dp.Radian = float.Pi * 2;
            dp.Position = dealpos;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_BlueMirrorConeGuide1";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_BlueMirrorConeGuide2";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_BlueMirrorConeGuide3";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_BlueMirrorConeGuide4";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
        ...
        [ScriptMethod(name: "P2_TwoMirrors_RedMirrorDonutAndConeGuide", eventType: EventTypeEnum.EnvControl, eventCondition: ["DirectorId:800375BF", "State:02000100"])]
        public void P2_TwoMirrors_RedMirrorDonutAndConeGuide(Event @event, ScriptAccessory accessory)
        {
            if (parse!=22) return;
            if (!int.TryParse(@event["Index"], out var dir8)) return;
            Vector3 npos = new(100, 0, 80);
            ...
            var dur = 4000;
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_RedMirrorDonut";
            dp.Scale = new(20);
            dp.InnerScale = new(4);
            dp.Radian = float.Pi * 2;
            dp.Position = dealpos;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_RedMirrorConeGuide1";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_RedMirrorConeGuide2";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_RedMirrorConeGuide3";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_TwoMirrors_RedMirrorConeGuide4";
            dp.Scale = new(60);
            dp.Radian = float.Pi / 6;
            dp.Position = dealpos;
            dp.TargetResolvePattern = PositionResolvePatternEnum.PlayerNearestOrder;
        ...
        public void Phase2_Rough_Guidance_Of_Red_Mirrors(Event @event, ScriptAccessory accessory)
        {
               ...
               ((leftMirror + 1) % 8) == phase2_getOppositeProteanPosition(colourlessMirror))
            {
                ...
                if (Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Left_Red_Melee_Group_Go_Left_Red_Mirror
                   ||
                   Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Closest_Red_Left_If_Same_Melee_Group_Closest_Red_Mirror_Left_If_Same)
                {
                ...
                if (Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Right_Red_Melee_Group_Go_Right_Red_Mirror
                   ||
                   Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Closest_Red_Right_If_Same_Melee_Group_Closest_Red_Mirror_Right_If_Same_Moglin_Meow_And_MMW)
                {
            ...
            else
            {
                ...
                if (discreteDistanceToTheLeft < discreteDistanceToTheRight)
                {
                    ...
                    if (Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Closest_Red_Left_If_Same_Melee_Group_Closest_Red_Mirror_Left_If_Same
                       ||
                       Phase2_Strat_Of_Mirror_Mirror == Phase2_Strats_Of_Mirror_Mirror.Melee_Group_Closest_Red_Right_If_Same_Melee_Group_Closest_Red_Mirror_Right_If_Same_Moglin_Meow_And_MMW)
                    {
        ...
        public void Phase2_Initial_Positions_Before_Light_Rampant(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase2_Initial_Protean_Position_Of_Light_Rampant == Phase2_Initial_Protean_Positions_Of_Light_Rampant.Normal_Protean_Tanks_North_East_For_Both_Grey9_Normal_Protean_Tanks_North_East_For_Grey9)
            {
            ...
            if (Phase2_Initial_Protean_Position_Of_Light_Rampant == Phase2_Initial_Protean_Positions_Of_Light_Rampant.Supporters_North_MOTH12_For_JPPF_And_L_Supporters_All_North_MSTH12_For_JPPF_And_L)
            {
            ...
            if (Phase2_Initial_Protean_Position_Of_Light_Rampant == Phase2_Initial_Protean_Positions_Of_Light_Rampant.Supporters_North_H12MOT_For_JPPF_And_L_Supporters_All_North_H12MST_For_JPPF_And_L)
            {
        ...
        public void Phase2_Rough_Path_Of_Luminous_Hammer(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase2_Strat_Of_Light_Rampant == Phase2_Strats_Of_Light_Rampant.Star_Of_David_Japanese_PF_Star_Of_David_Japanese_PF_Moglin_Meow_And_MMW)
            {
            ...
            if (Phase2_Strat_Of_Light_Rampant == Phase2_Strats_Of_Light_Rampant.New_Grey9_New_Grey9_Moglin_Meow_And_MMW)
            {
        ...
        public void Phase2_Guidance_Of_Towers_During_Light_Rampant(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase2_Strat_Of_Light_Rampant == Phase2_Strats_Of_Light_Rampant.Star_Of_David_Japanese_PF_Star_Of_David_Japanese_PF_Moglin_Meow_And_MMW)
            {
                accessory.Log.Debug("Star_Of_David_Japanese_PF_Moglin_Meow_And_MMW");
            ...
            if (Phase2_Strat_Of_Light_Rampant == Phase2_Strats_Of_Light_Rampant.Lucrezia_L_Strat)
            {
                accessory.Log.Debug("Lucrezia_L_Strat");
                myTower = myTetherIndex switch
                {
                    1 => tower1,
                    4 => tower4,
            ...
            if (Phase2_Strat_Of_Light_Rampant == Phase2_Strats_Of_Light_Rampant.Obsolete_Old_Grey9_Obsolete_Old_Grey9_Moglin_Meow)
            {
                accessory.Log.Debug("Obsolete_Old_Grey9_Moglin_Meow");
                int numberOfPlayersWithLuminousHammerBefore = 0;
        ...
        [ScriptMethod(name: "P2_LightRampant_ProteanSpreadPosition", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:regex:^(4022[01])$"])]
        public void P2_LightRampant_ProteanSpreadPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=23) return;
            var myindex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
            var rot8 = myindex switch
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P2_LightRampant_ProteanSpreadPosition";
            dp.Scale = new(2);
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = mPosEnd;
            dp.ScaleMode |= ScaleMode.YByDistance;
        ...
        [ScriptMethod(name: "P2_LightRampant_SphereExplosionTimeDrawing", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40219)$"],
            userControl: true)]
        public void P2_LightRampant_SphereExplosionTimeDrawing(Event @ev, ScriptAccessory sa)
        {
            // 
        ...
        [ScriptMethod(name: "P3_UltimateRelativity_PhaseChange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40266)$"], userControl: false)]
        public void P3_UltimateRelativity_PhaseChange(Event @event, ScriptAccessory accessory)
        {
            parse=31;
        ...
        [ScriptMethod(name: "P3_UltimateRelativity_LampWiseRecord", eventType: EventTypeEnum.StatusAdd, eventCondition: ["StatusID:2970"], userControl: false)]
        public void P3_UltimateRelativity_LampWiseRecord(Event @event, ScriptAccessory accessory)
        {
        ...
        [ScriptMethod(name: "P3_UltimateRelativity_BuffHandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40293"])]
        public void P3_UltimateRelativity_BuffHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=31) return;
            var myIndex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
            if (myIndex == -1) return;
            ...
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_ShortFire_PlaceFire";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_ShortFire_PlaceReturn";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
            ...
            if (myFire == 2)
            {
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_MediumFire_PlaceReturn";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = RotatePoint(returnPosN, centre, myRot);
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_MediumFire_PlaceFire";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = RotatePoint(fireN, centre, myRot);
            ...
            if (myFire == 3)
            {
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_LongFire_PlaceFire";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = RotatePoint(fireN, centre, myRot);
            ...
            if (myFire == 4)
            {
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P3_UltimateRelativity_IceTH_PlaceIce";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = centre;
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P3_UltimateRelativity_IceTH_PlaceReturn";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = RotatePoint(returnPosN, centre, myRot);
                ...
                else
                {
                    ...
                    dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P3_UltimateRelativity_IceD_PlaceIce";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = centre;
        ...
        [ScriptMethod(name: "P3_UltimateRelativity_LampHandlingPosition", eventType: EventTypeEnum.StatusAdd, eventCondition: ["StatusID:2970"])]
        public void P3_UltimateRelativity_LampHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=31) return;
            //buff2970, 13 269 clockwise 92 348 counterclockwise
            var pos = JsonConvert.DeserializeObject<Vector3>(@event["TargetPosition"]);
            ...
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P3_UltimateRelativity_LampHandlingPosition";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
        ...
        [ScriptMethod(name: "P3_AutoFaceLampAfterStun", eventType: EventTypeEnum.StatusAdd, eventCondition: ["StatusID:4163"], userControl: true, suppress: 10000)]
        public void P3_AutoFaceLampAfterStun(Event @event, ScriptAccessory accessory)
        {
            if (parse != 31) return;
        ...
        [ScriptMethod(name: "P3_DelayedEchoes_PhaseChange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(40269)$"], userControl: false)]
        public void P3_DelayedEchoes_PhaseChange(Event @event, ScriptAccessory accessory)
        {
            parse=32;
            P3FloorFire = -1;
            phase3_typeOfDarkWaterIii = [
        ...
        public void Phase3_Prompt_Before_Dark_Water_III(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase3_Strat_Of_The_Second_Half == Phase3_Strats_Of_The_Second_Half.High_Priority_As_Locomotives_Locomotive_Strat_MMW)
            {
                ...
                if (Phase3_Branch_Of_The_Locomotive_Strat == Phase3_Branches_Of_The_Locomotive_Strat.MT_And_M1_As_Locomotives_MT_And_D1_As_Locomotives_MMW)
                {
                ...
                if (Phase3_Branch_Of_The_Locomotive_Strat == Phase3_Branches_Of_The_Locomotive_Strat.Others_As_Locomotives_Chinese_PF_Others_As_Locomotives_Chinese_PF)
                {
            ...
            if (Phase3_Strat_Of_The_Second_Half == Phase3_Strats_Of_The_Second_Half.Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs_Moglin_Meow_Or_Baby_Wheelchair_Based_On_Signs)
            {
        ...
        public void Phase3_Determine_Initial_Safe_Positions_Of_Apocalypse(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase3_Strat_Of_The_Second_Half == Phase3_Strats_Of_The_Second_Half.Double_Group)
            {
                ...
                if (Phase3_Branch_Of_The_Double_Group_Strat == Phase3_Branches_Of_The_Double_Group_Strat.Based_On_Safe_Positions_Based_On_Safe_Positions_MMW)
                {

                    if (Phase3_Division_Of_The_Zone == Phase3_Divisions_Of_The_Zone.North_To_Southwest_For_The_Left_Group_North_To_Southwest_For_The_Left_Group_Moglin_Meow_And_MMW)
                    {
                    ...
                    if (Phase3_Division_Of_The_Zone == Phase3_Divisions_Of_The_Zone.Northwest_To_South_For_The_Left_Group_Northwest_To_South_For_The_Left_Group)
                    {
                ...
                if (Phase3_Branch_Of_The_Double_Group_Strat == Phase3_Branches_Of_The_Double_Group_Strat.Based_On_The_Second_Apocalypse_Based_On_The_Second_Apocalypse)
                {
        ...
        [ScriptMethod(name: "P3_DelayedEchoes_FloorFire", eventType: EventTypeEnum.ObjectEffect, eventCondition: ["Id1:4", "Id2:regex:^(16|64)$"], suppress: 2000)]
        public void P3_DelayedEchoes_FloorFire(Event @event, ScriptAccessory accessory)
        {
            if (parse!=32) return;
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_Center";
            dp.Scale = new(9);
            dp.Position = centre;
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Delay = 3000;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_StartingPoint_11";
            dp.Scale = new(9);
            dp.Position = pos;
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Delay = 3000;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_StartingPoint_12";
            dp.Scale = new(9);
            dp.Position = pos;
            dp.Color = accessory.Data.DefaultDangerColor;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_StartingPoint_21";
            dp.Scale = new(9);
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_StartingPoint_22";
            dp.Scale = new(9);
            dp.Position = RotatePoint(pos, centre, float.Pi);
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Delay = 17000 - preTime;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_SecondPoint_11";
            dp.Scale = new(9);
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_SecondPoint_12";
            dp.Scale = new(9);
            dp.Position = RotatePoint(pos, centre, float.Pi / 4 * clockwise);
            dp.Color = accessory.Data.DefaultDangerColor;
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_SecondPoint_21";
            dp.Scale = new(9);
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_SecondPoint_22";
            dp.Scale = new(9);
            dp.Position = RotatePoint(pos, centre, float.Pi / 4 * clockwise + float.Pi);
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Delay = 19000 - preTime;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_ThirdPoint_11";
            dp.Scale = new(9);
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_ThirdPoint_12";
            dp.Scale = new(9);
            dp.Position = RotatePoint(pos, centre, float.Pi / 2 * clockwise);
            dp.Color = accessory.Data.DefaultDangerColor;
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_ThirdPoint_21";
            dp.Scale = new(9);
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_ThirdPoint_22";
            dp.Scale = new(9);
            dp.Position = RotatePoint(pos, centre, float.Pi / 2 * clockwise + float.Pi);
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Delay = 11000 - preTime;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_FourthPoint_11";
            dp.Scale = new(9);
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_SecondHalf_FloorFire_FourthPoint_21";
            dp.Scale = new(9);
        ...
        [ScriptMethod(name: "P3_DelayedEchoes_KnockbackPrompt", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:40182", "TargetIndex:1"])]
        public void P3_DelayedEchoes_KnockbackPrompt(Event @event, ScriptAccessory accessory)
        {
            if (parse!=32) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;

            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_DelayedEchoes_KnockbackPrompt1";
            dp.Scale = new(2, 21);
            dp.Owner = accessory.Data.Me;
            dp.TargetObject = sid;
            dp.Rotation = float.Pi;
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P3_DelayedEchoes_KnockbackPrompt2";
            dp.Scale = new(2);
            dp.Owner = sid;
        ...
        [ScriptMethod(name: "P3_DelayedEchoes_FloorFireRecord", eventType: EventTypeEnum.ObjectEffect, eventCondition: ["Id1:4", "Id2:regex:^(16|64)$"], userControl: false)]
        public void P3_DelayedEchoes_FloorFireRecord(Event @event, ScriptAccessory accessory)
        {
            if (parse!=32) return;
            lock (this)
            {
        ...
        private int MyLampIndex(int myPartyIndex)
        {
            ...
            if (Phase3_Strat_Of_The_First_Half == Phase3_Strats_Of_The_First_Half.Moogle_Moogle_Moglin_Meow_And_MMW)
            {
                //Short Fire
        ...
        [ScriptMethod(name: "P4_Materialization_PhaseChange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40246"], userControl: false)]
        public void P4_Materialization_PhaseChange(Event @event, ScriptAccessory accessory)
        {
            parse=41;
        }
        [ScriptMethod(name: "P4_CrystallizeTime_FragmentCollection", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40174"], userControl: false)]
        public void P4_CrystallizeTime_FragmentCollection(Event @event, ScriptAccessory accessory)
        {
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            P4FragmentId = sid;
        }
        [ScriptMethod(name: "P4_Materialization_AkhRhai", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40237"])]
        public void P4_Materialization_AkhRhai(Event @event, ScriptAccessory accessory)
        {
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P4_Materialization_AkhRhai";
            dp.Scale = new(4);
            dp.Owner = sid;
            dp.TargetObject = sid;
            dp.Color = accessory.Data.DefaultDangerColor;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_PhaseChange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40239"], userControl: false)]
        public void P4_DarklitDragonsong_PhaseChange(Event @event, ScriptAccessory accessory)
        {
            parse=42;
            P4Tether = [-1, -1, -1, -1, -1, -1, -1, -1];
            P4Stack = [0, 0, 0, 0, 0, 0, 0, 0];
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_TetherCollection", eventType: EventTypeEnum.Tether, eventCondition: ["Id:006E"], userControl: false)]
        public void P4_DarklitDragonsong_TetherCollection(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            if (!ParseObjectId(@event["TargetId"], out var tid)) return;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_GuideCone", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40187"])]
        public void P4_DarklitDragonsong_GuideCone(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;
            for (uint i = 1; i < 5; i++)
            {
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_DarklitDragonsong_GuideCone";
                dp.Scale = new(20);
        ...
        public void P4_DarklitDragonsong_WaterStack(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Double_Swaps_Baiting_First_Bait_Then_Double_Swaps)
            {
            ...
            if (Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Single_Swap_Baiting_After_Single_Swap_Then_Bait_Moglin_Meow_And_MMW || Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Single_Swap_Baiting_First_Bait_Then_Single_Swap)
            {
                if (upGroup.Contains(tetherStack))
                {
                    //tether stack in up
        ...
        #region SomberDance
        [ScriptMethod(name: "P4_DarklitDragonsong_FarBait", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40283"])]
        public void P4_DarklitDragonsong_FarBait(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            if (!ParseObjectId(@event["SourceId"], out var sid)) return;

            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P4_DarklitDragonsong_FarBait";
            dp.Scale = new(8);
            dp.Owner = sid;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_NearBait", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:40284"])]
        public void P4_DarklitDragonsong_NearBait(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            var pos = JsonConvert.DeserializeObject<Vector3>(@event["TargetPosition"]);

            var dp2 = accessory.Data.GetDefaultDrawProperties();
            dp2.Name = "P4_DarklitDragonsong_NearBait";
            dp2.Scale = new(8);
            dp2.Position = pos;
        ...
        #endregion
        [ScriptMethod(name: "P4_DarklitDragonsong_LightBound_KeepDistancePrompt", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:40271"], suppress: 2000)]
        public void P4_DarklitDragonsong_LightBound_KeepDistancePrompt(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_TowerHandlingPosition", eventType: EventTypeEnum.Tether, eventCondition: ["Id:006E"])]
        public void P4_DarklitDragonsong_TowerHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            ...
            var dur = 10000;
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P4_DarklitDragonsong_TowerHandlingPosition";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_GuideHandlingPosition", eventType: EventTypeEnum.Tether, eventCondition: ["Id:006E"], suppress: 2000)]
        public void P4_DarklitDragonsong_GuideHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=42) return;
            ...
            Vector3 dealpos = new();
            if (Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Double_Swaps_Baiting_First_Bait_Then_Double_Swaps || Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Single_Swap_Baiting_First_Bait_Then_Single_Swap)
            {
                List<int> idles = [];
                for (int i = 0; i < 8; i++)
                {
            ...
            if (Phase4_Strat_Of_The_First_Half == Phase4_Strats_Of_The_First_Half.Single_Swap_Baiting_After_Single_Swap_Then_Bait_Moglin_Meow_And_MMW)
            {
                var tIndex = P4Tether[0] == -1 ? 1 : 0;
                var nIndex = P4Tether[2] == -1 ? 3 : 2;
                var d1Index = -1;
            ...
            var dur = 10000;
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P4_DarklitDragonsong_GuideHandlingPosition";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos;
        ...
        [ScriptMethod(name: "P4_DarklitDragonsong_StackHandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(4022[78])$"])]
        public void P4_DarklitDragonsong_StackHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            var tIndex = P4Tether[0] == -1 ? 1 : 0;
            var nIndex = P4Tether[2] == -1 ? 3 : 2;
            var d1Index = -1;
            ...
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P4_DarklitDragonsong_StackHandlingPosition";
            dp.Scale = new(2);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = dealpos;
        ...
        public class PriorityDict
        {
            ...
            /// <summary>
            /// Increases priority for a specific key
            /// </summary>
            ...
            /// <summary>
            /// Finds the first 'num' keys with the smallest values from Priorities and returns a new Dict
            /// </summary>
            ...
            /// <summary>
            /// Finds the first 'num' keys with the largest values from Priorities and returns a new Dict
            /// </summary>
            /// <param name="num"></param>
            /// <returns></returns>
            ...
            /// <summary>
            /// Finds the keys in the middle of the ascending sort from Priorities and returns a new Dict
            /// </summary>
            /// <param name="skip">Number of elements to skip. If starting from the second element, skip=1</param>
            /// <param name="num"></param>
            /// <param name="descending">Descending order, default is false</param>
            /// <returns></returns>
            ...
            /// <summary>
            /// Finds the data at the 'idx' position in the ascending sort from Priorities and returns a new Dict
            /// </summary>
            ...
            /// <summary>
            /// Finds the data corresponding to the key from Priorities and returns its position in the sorted values
            /// </summary>
            ...
            /// <summary>
            /// Increases priority values all at once
            ...
            public void AddPriorities(List<int> priorities)
            {
                if (Priorities.Count != priorities.Count)
                    sa.Log.Error("Input list length does not match internal length");
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_PhaseChange", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40240"], userControl: false)]
        public void P4_CrystallizeTime_PhaseChange(Event @event, ScriptAccessory accessory)
        {
            parse=43;
            ...
            {
                // Smaller number means higher priority (more left), default is HTD order.
                Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_THD_Order_By_THD_Order_Moglin_Meow => [0, 1, 2, 3, 4, 5, 6, 7],
                Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_HTD_Order_By_HTD_Order_MMW => [2, 3, 0, 1, 4, 5, 6, 7],
                Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_H1TDH2_Order_By_H1TDH2_Order => [1, 2, 0, 7, 3, 4, 5, 6],
                _ => [2, 3, 0, 1, 4, 5, 6, 7],
            };
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_BuffCollection", eventType: EventTypeEnum.StatusAdd, eventCondition: ["StatusID:regex:^(326[34]|2454|246[0123])$"], userControl: false)]
        public void P4_CrystallizeTime_BuffCollection(Event @event, ScriptAccessory accessory)
        {
            if (parse!=43) return;
            ...
            if (id.Equals("3263")||id.Equals("3264"))
            {
                ...
                lock (phase4_readwriteLockOfMajorDebuffCounter_AsAConstant)
                {
                    ...
                    if (phase4_numberOfMajorDebuffsHaveBeenCounted == 8)
                    {
                        ...
                        _events[0].Set();   // Blue/Red recording complete
                    }
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_CalculateGroupAssignment",
            eventType: EventTypeEnum.ActionEffect,
            eventCondition: ["ActionId:40298"],
            userControl: false,
            suppress: 10000)]

        public void P4_CrystallizeTime_CalculateGroupAssignment(Event @event, ScriptAccessory accessory)
        {
            if (parse!=43) return;
            ...
            _events[1].WaitOne();
            /*
            *   In the priority value, the units digit corresponds to job priority, the tens digit corresponds to attribute buff, the hundreds digit corresponds to red/blue buff
            *   Units digit: varies depending on TDH, HTD, HTDH settings
            *   Tens digit: Ice+0, Wind+10, Water+20, Earth+30, Dark+40
            *   Hundreds digit: Red+0, Blue+100
            *   After sorting ascending, we get: [LeftRedIce, RightRedIce, LeftRedWind, RightRedWind, BlueIce, BlueWater, BlueEarth, BlueDark]
            */
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_ReceiveExternalMarkers",
            eventType: EventTypeEnum.Marker,
            eventCondition: ["Operate:Add", "Id:regex:^(0[679]|10)$"],
            userControl: false)]

        public void P4_CrystallizeTime_ReceiveExternalMarkers(Event @event, ScriptAccessory accessory)
        {
            if (parse!=43) return;
            ...
            // If external markers exist, follow them
            switch (sign)
            {
                case stop1:
                    _cry.LeftIcePlayerIdx = index;
                    accessory.Log.Debug($"CrystallizeTime: Received external stop1 marker, assigned to {index}");
                    break;
                case stop2:
                    _cry.RightIcePlayerIdx = index;
                    accessory.Log.Debug($"CrystallizeTime: Received external stop2 marker, assigned to {index}");
                    break;
                case bind1:
                    _cry.LeftWindPlayerIdx = index;
                    accessory.Log.Debug($"CrystallizeTime: Received external bind1 marker, assigned to {index}");
                    break;
                case bind2:
                    _cry.RightWindPlayerIdx = index;
                    accessory.Log.Debug($"CrystallizeTime: Received external bind2 marker, assigned to {index}");
                    break;
                default:
                    break;
            }
        ...
        public void Phase4_Mark_Teammates_During_The_Second_Half(Event @event, ScriptAccessory accessory)
        {
            ...
            if(Phase4_Player_Type_To_Be_Marked==Phase4_Player_Types_To_Be_Marked.Both_The_Debuffs_Wyrmclaw_And_Wyrmfang_Mark_Both_Wyrmclaw_And_Wyrmfang
               ||
               Phase4_Player_Type_To_Be_Marked==Phase4_Player_Types_To_Be_Marked.Only_Wyrmfang_The_Blue_Debuff_Mark_Only_Wyrmfang_Blue_Debuff) {

            if (Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang == Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_Debuffs_1234_From_East_To_West_According_To_Debuffs_1234_From_East_To_West
                ||
                Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang==Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_Debuffs_1342_From_East_To_West_According_To_Debuffs_1342_From_East_To_West)
            {
            ...
            if (Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang == Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_The_Priority_THD_According_To_THD_Priority)
            {
            ...
            if (Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang == Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_The_Priority_HTD_According_To_HTD_Priority)
            {
            ...
            if (Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang == Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_The_Priority_H1TDH2_According_To_H1TDH2_Priority)
            {
            ...
            if(Phase4_Player_Type_To_Be_Marked==Phase4_Player_Types_To_Be_Marked.Both_The_Debuffs_Wyrmclaw_And_Wyrmfang_Mark_Both_Wyrmclaw_And_Wyrmfang
               ||
               Phase4_Player_Type_To_Be_Marked==Phase4_Player_Types_To_Be_Marked.Only_Wyrmclaw_The_Red_Debuff_Mark_Only_Wyrmclaw_Red_Debuff) {

                temporaryOrder=[0,1,2,3,4,5,6,7];

                if(Phase4_Priority_Of_The_Players_With_Wyrmclaw==Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_THD_Order_By_THD_Order_Moglin_Meow) {
                    
                    temporaryOrder=[0,1,2,3,4,5,6,7];
                    
                }
                
                if(Phase4_Priority_Of_The_Players_With_Wyrmclaw==Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_HTD_Order_By_HTD_Order_MMW) {
                    
                    temporaryOrder=[2,3,0,1,4,5,6,7];
                    
                }
                
                if(Phase4_Priority_Of_The_Players_With_Wyrmclaw==Phase4_Priorities_Of_The_Players_With_Wyrmclaw.In_H1TDH2_Order_By_H1TDH2_Order) {
                ...
                if(Phase4_Logic_Of_Marking_Teammates_With_Wyrmclaw==Phase4_Logics_Of_Marking_Teammates_With_Wyrmclaw.Ignore1_And_Bind1_Go_West_Ignore1_And_Bind1_Go_West_Moglin_Meow) {
                ...
                if(Phase4_Logic_Of_Marking_Teammates_With_Wyrmclaw==Phase4_Logics_Of_Marking_Teammates_With_Wyrmclaw.Ignore1_And_Ignore2_Go_West_Ignore1_And_Ignore2_Go_West) {
        ...
        private int phase4_getMarkIndex(Phase4_Relative_Positions_Of_Residues currentPosition) {
            ...
            if(Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang==Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_Debuffs_1234_From_East_To_West_According_To_Debuffs_1234_From_East_To_West) {
                ...
                if(currentPosition==Phase4_Relative_Positions_Of_Residues.Eastmost) {

                    return 0;

                }

                if(currentPosition==Phase4_Relative_Positions_Of_Residues.About_East) {

                    return 1;

                }

                if(currentPosition==Phase4_Relative_Positions_Of_Residues.About_West) {

                    return 2;

                }

                if(currentPosition==Phase4_Relative_Positions_Of_Residues.Westmost) {
            ...
            if(Phase4_Logic_Of_Marking_Teammates_With_Wyrmfang==Phase4_Logics_Of_Marking_Teammates_With_Wyrmfang.According_To_Debuffs_1342_From_East_To_West_According_To_Debuffs_1342_From_East_To_West) {
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_BlueTetherCollection", eventType: EventTypeEnum.Tether, eventCondition: ["Id:0085"], userControl: false)]
        public void P4_CrystallizeTime_BlueTetherCollection(Event @event, ScriptAccessory accessory)
        {
            if (parse!=43) return;
            var pos = JsonConvert.DeserializeObject<Vector3>(@event["SourcePosition"]);
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_BuffHandlingPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40293"])]
        public void P4_CrystallizeTime_BuffHandlingPosition(Event @event, ScriptAccessory accessory)
        {
            ...
            if (P4ClawBuff[myIndex] == 1)
            {
                ...
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_HitDragon";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_pos2PreviewLine";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Position = dealpos;
                dp.TargetPosition = dealpos2;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_pos2Position";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos2;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_pos3PreviewLine";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_pos3Position";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos3;
            ...
            if (P4ClawBuff[myIndex] == 2)
            {
                ...
                var dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeAC";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos1;
                ...
                accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeAC_to_Knockback";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Position = dealpos1;
                dp.TargetPosition = dealpos2;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_Knockback";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos2;
                ...
                accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_Knockback_to_DodgeDiagonal";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Position = dealpos2;
                dp.TargetPosition = dealpos3;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeDiagonal";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos3;
                ...
                accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeDiagonal_to_HitHead";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                ...
                dp = accessory.Data.GetDefaultDrawProperties();
                dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_HitHead";
                dp.Scale = new(2);
                dp.ScaleMode |= ScaleMode.YByDistance;
                dp.Owner = accessory.Data.Me;
                dp.TargetPosition = dealpos4;
            ...
            if (P4ClawBuff[myIndex] == 3)
            {
                if (P4OtherBuff[myIndex] == 4)
                {
                    ...
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeLamp1";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = dealpos1;
                ...
                else
                {
                    ...
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_BuffHandlingPosition_DodgeLampAC";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                    dp.TargetPosition = dealpos1;
        ...
        [ScriptMethod(name: "P4_CrystallizeTime_PlaceReturnPosition", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40251"])]
        public void P4_CrystallizeTime_PlaceReturnPosition(Event @event, ScriptAccessory accessory)
        {
            if (parse!=43) return;
            var pos = JsonConvert.DeserializeObject<Vector3>(@event["SourcePosition"]);
            P4WaterPos.Add(pos);
            ...
            var myindex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
            Vector3 centre = new(100, 0, 100);
            if (Phase4_Position_Before_Knockback == Phase4_Positions_Before_Knockback.Normal_Normal_Moglin_Meow_And_MMW)
            {
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_PlaceReturnPosition_MT";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_PlaceReturnPosition_ST";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_PlaceReturnPosition_MTG";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
                ...
                {
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = "P4_CrystallizeTime_PlaceReturnPosition_STG";
                    dp.Scale = new(2);
                    dp.ScaleMode |= ScaleMode.YByDistance;
                    dp.Owner = accessory.Data.Me;
            ...
            if (Phase4_Position_Before_Knockback == Phase4_Positions_Before_Knockback.Y_Formation_Japanese_PF_Y_Formation_Japanese_PF)
            {
        ...
        public void Phase4_Acquire_IDs_Of_Drachen_Wanderers(Event @event, ScriptAccessory accessory)
        {
            ...
            lock (phase4_readwriteLockOfDrachenWandererIds_AsAConstant)
            {
                ...
                if (spos.X < 100)
                {
                    ...
                    accessory.Log.Debug($"CrystallizeTime: Recorded left Drachen Wanderer {spos} ID {sourceId}");
                }
                else
                {
                    _cry.RightWyrmSid = sourceId;
                    accessory.Log.Debug($"CrystallizeTime: Recorded right Drachen Wanderer {spos} ID {sourceId}");
                }
                ...
                {
                    _events[3].Set();
                    accessory.Log.Debug($"CrystallizeTime: Left and right Drachen Wanderers recorded.");
                }
        ...
        public void Phase4_Explosion_Range_Of_Drachen_Wanderers(Event @event, ScriptAccessory accessory)
        {
            ...
            // Usami:
            // The permanent display of explosion range will cause players hitting the Drachen Wanderer to misjudge the lamp's iron donut.
            // Idea as follows:
            // If the player is RedIce or RedWind, do not display the explosion range of the Drachen Wanderer on their side, instead use a very small green circle to indicate the Drachen Wanderer's position.
            // Because the explosion of the Drachen Wanderer on their side will affect the judgment of the lamp.
            // After one side's RedIce hits, they gather with the group, while the other side's RedIce needs to observe the lamp on their side, quickly passing through after the explosion, unrelated to the Drachen Wanderer.
            // RedWind needs to observe the lamp's explosion and then quickly pass through to hit the Drachen Wanderer. Two similar drawings will affect judgment.
            // For Blue debuff players, no modification is needed. BlueDark needs to avoid the Drachen Wanderer's explosion range, the remaining three are not involved in the Drachen Wanderer path at all, leaving them is fine.
        ...
        public void Phase4_Guidance_Of_Residues(Event @event, ScriptAccessory accessory)
        {
            ...
            if (Enable_Developer_Mode)
            {
                ...
                if (Phase4_Logic_Of_Residue_Guidance == Phase4_Logics_Of_Residue_Guidance.According_To_Signs_On_Me_According_To_Signs_On_Me_Moglin_Meow_And_MMW)
                {
            ...
            if (relativePositionOfMyResidue != Phase4_Relative_Positions_Of_Residues.Unknown
               &&
               idOfMyResidue != 0)
            {
        ...
        private Phase4_Relative_Positions_Of_Residues phase4_getRelativePosition(int currentIndex)
        {
            ...
            if (Phase4_Logic_Of_Residue_Guidance == Phase4_Logics_Of_Residue_Guidance.According_To_Debuffs_According_To_Debuffs)
            {
        ...
        private ulong phase4_getResidueId(Phase4_Relative_Positions_Of_Residues relativePosition)
        {
            ...
            switch (relativePosition)
            {
                ...
                case (Phase4_Relative_Positions_Of_Residues.Eastmost):
                    {
                ...
                case (Phase4_Relative_Positions_Of_Residues.About_East):
                    {
                ...
                case (Phase4_Relative_Positions_Of_Residues.About_West):
                    {
                ...
                case (Phase4_Relative_Positions_Of_Residues.Westmost):
                    {
                ...
                case (Phase4_Relative_Positions_Of_Residues.Unknown):
                    {
        ...
        {
            if (Phase == "P5FloorFireCalculationComplete")//Limit group
             {
                 lock (drawLock)
                 {
                     Phase = "P5CalculationEnd";
                     //accessory.Method.SendChat($"/e P5CalculationEnd");
                     var id = Convert.ToUInt32(@event["SourceId"], 16);
                     Vector2 FarthestPoint = new Vector2();
                     Vector2 ClosestPoint = new Vector2();
                     if (id == P1P3Blades[0].Id || id == P1P3Blades[1].Id) //P1 start fire
                     {
                         FarthestPoint = FindFarthestPoint(OnPoint, Point1);
                         ClosestPoint = FindClosestPoint(OnPoint, Point1);
                     }
                     else if (id == P1P3Blades[2].Id || id == P1P3Blades[3].Id) //P3 start fire
                     {
                     ...
                     //Far Near Near Far
                     BladeRoutes.Insert(0, FarthestPoint); //1st run start point, farthest from start fire
                     BladeRoutes.Insert(1, ClosestPoint); //2nd run start point, closest to start fire
                     ...
                     BladeRoutes.Insert(4, ClosestPoint); //5th run start point, closest to start fire
                     BladeRoutes.Insert(5, FarthestPoint); //5th run start point, farthest from start fire
                     ...
                     /////////////////////////////////////1 green release 2 base delay 9000
                     ...
                     /////////////////////////////////////2 green release 3 base delay 9000+bladetime
                     ...
                     /////////////////////////////////////3 green release 4 base delay 9000+bladetime*2
                     ...
                     /////////////////////////////////////4 green release 5 base delay 9000+bladetime*3
                     ...
                     /////////////////////////////////////5 green release 6 base delay 9000+bladetime*4
        ...
        public void P5_WingsDarkAndLight(Event @event, ScriptAccessory accessory)
        {
            ...
            dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "P5_WingsDarkAndLight_FarNear";
            dp.Scale = new(4);
            dp.Owner = sid;
        ...
        public void Phase5_Guidance_For_Tanks_During_Towers(Event @event, ScriptAccessory accessory) {
            ...
            if(Phase5_Strat_Of_Wings_Dark_And_Light==Phase5_Strats_Of_Wings_Dark_And_Light.Grey9_Brain_Dead_MT_First_Tower_Opposite_Grey9_Brain_Dead_MT_First_Tower_Opposite_Moglin_Meow_And_MMW) {
            ...
            if(Phase5_Strat_Of_Wings_Dark_And_Light==Phase5_Strats_Of_Wings_Dark_And_Light.Reverse_Triangle_MT_Baits_In_Towers_Reverse_Triangle_MT_Baits_In_Towers) {
        ...
        public void Phase5_Guidance_For_Others_During_Towers(Event @event, ScriptAccessory accessory) {
            ...
            */
            ...
            if(Phase5_Strat_Of_Wings_Dark_And_Light==Phase5_Strats_Of_Wings_Dark_And_Light.Grey9_Brain_Dead_MT_First_Tower_Opposite_Grey9_Brain_Dead_MT_First_Tower_Opposite_Moglin_Meow_And_MMW) {
                ...
                if(Phase5_Branch_Of_The_Grey9_Brain_Dead_Strat==Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat.Melees_First_Then_Healers_Left_Ranges_Right_Melees_First_Then_Healers_Left_Ranges_Right) {
                ...
                if(Phase5_Branch_Of_The_Grey9_Brain_Dead_Strat==Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat.Healers_First_Then_Melees_Left_Ranges_Right_Healers_First_Then_Melees_Left_Ranges_Right_Moglin_Meow) {
                ...
                if(Phase5_Branch_Of_The_Grey9_Brain_Dead_Strat==Phase5_Branches_Of_The_Grey9_Brain_Dead_Strat.Healer_First_Then_Melees_Farther_Ranges_Closer_Healer_First_Then_Melees_Farther_Ranges_Closer_MMW) {
            ...
            if(Phase5_Strat_Of_Wings_Dark_And_Light==Phase5_Strats_Of_Wings_Dark_And_Light.Reverse_Triangle_MT_Baits_In_Towers_Reverse_Triangle_MT_Baits_In_Towers) {
                ...
                if(Phase5_Branch_Of_The_Reverse_Triangle_Strat==Phase5_Branches_Of_The_Reverse_Triangle_Strat.Melees_First_Then_Healers_Left_Ranges_Right_Melees_First_Then_Healers_Left_Ranges_Right) {
                ...
                if(Phase5_Branch_Of_The_Reverse_Triangle_Strat==Phase5_Branches_Of_The_Reverse_Triangle_Strat.Healers_First_Then_Melees_Left_Ranges_Right_Healers_First_Then_Melees_Left_Ranges_Right) {
        ...
        private int phase5_getRoundToTakeHits(int currentIndex)
        {
            ...
            if (Phase5_Order_During_Polarizing_Strikes == Phase5_Orders_During_Polarizing_Strikes.Tanks_Melees_Ranges_Healers_Tanks_Melees_Ranges_Healers_Moglin_Meow_And_MMW)
            {
            ...
            if (Phase5_Order_During_Polarizing_Strikes == Phase5_Orders_During_Polarizing_Strikes.Tanks_Healers_Melees_Ranges_Tanks_Healers_Melees_Ranges)
            {
        ...
        {
            //Calculate sine and cosine of the direction
        ...
        public static Vector2? middlePoint(Vector2? P1, Vector2? P2)
        {
            ...
            return null; //If either point is null, return null
        }
        ...
        //Farthest sub-point of the main point
        public static Vector2 FindFarthestPoint(onPoint point, Vector2? referencePoint)
        {
            ...
            Vector2 farthestCoord = Vector2.Zero;//Initialize farthest coordinate
                                                 //Iterate through all coordinates to find the farthest
        ...
        //Closest sub-point of the main point
        public static Vector2 FindClosestPoint(onPoint point, Vector2? referencePoint)
        {
            ...
            // Iterate through all coordinates to find the closest
            foreach (var coord in coords)
            {
                float distance = Vector2.Distance(coord, referencePoint.Value);//Calculate distance
        ...
        [ScriptMethod(name: "P5FloorFire", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:40306"], userControl: false)]
        ...
        {
            if(Enable_Developer_Mode)accessory.Method.SendChat($"/e KnightRider wishes you good luck with the floor fire~");
        }

        //Capture group
        [ScriptMethod(name: "FloorFireDataCapture", eventType: EventTypeEnum.ObjectEffect, eventCondition: ["Id1:1"], userControl: false)]
        public void FloorFireDataCapture(Event @event, ScriptAccessory accessory)
        {
            if (Phase == "P5FloorFire")//Capture limited area
            {
                lock (bladeLock)
                {
                    if (bladeCount < 7) //If floor fire <7 continue capturing
                    {
                        var pos = JsonConvert.DeserializeObject<Vector3>(@event["SourcePosition"]);
                        //Store data
                    ...
                    if (blades.Count == 6) //If 6 floor fire data points collected
                    {
                        ProcessBlades();//Process three intersection points + change phase => P5FloorFireCalculationComplete
                        //accessory.Method.SendChat($"/e Go to point {OnPoint.Name} to start running");
                    }
                }
            }
        }
        ...
        private void ProcessBlades()
        {
            ...
            if (sortedBlades != null)
            {
                ...
                Point1 = mathPoint(sortedBlades[0], sortedBlades[1]);//Calculate intersection point 1
                Point2 = mathPoint(sortedBlades[2], sortedBlades[3]);//Calculate intersection point 2
                Point3 = mathPoint(sortedBlades[4], sortedBlades[5]);//Calculate intersection point 3
                MiddlePoint = middlePoint(Point1, Point3);//Calculate midpoint of points 1 and 3
                OnPoint = FindClosestOnPoint(onPoints,MiddlePoint);//Calculate which main point to start running from
                //accessory.Method.SendChat($"/e Go to point {OnPoint.Name} to start running");
                Phase = "P5FloorFireCalculationComplete";
            }
        }
    ...
    public static class Extensions
    {
        ...
        public static void SetRotation(this ScriptAccessory sa, IGameObject? obj, float rotation)
        {
            ...
            {
                sa.Log.Error($"The passed IGameObject is invalid.");
                return;
            }
            unsafe
            {
    ...
    public static class IndexHelper
    {
        ...
        /// </summary>
        /// <param name="accessory"></param>
        /// <returns>The position index corresponding to the main perspective player</returns>
        ...
        /// <summary>
        /// Input player dataId, get the corresponding position name, output text only for text output use
        /// </summary>
        /// <param name="pid">Player SourceId</param>
        /// <param name="accessory"></param>
        ...
        {
            // Get player job abbreviation, no practical use, only for DEBUG output
        ...
        /// <summary>
        /// Input position index, get the corresponding position name, output text only for text output use
        /// </summary>
