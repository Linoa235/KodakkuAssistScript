...
namespace KarlinScriptNamespace
{
    ...
    public class ValigarmandaExDraw
    {
        ...
        [ScriptMethod(name: "Gymnastics Circle", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:36812"])]
        public void GymnasticsCircle(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "Gymnastics Circle";
            dp.Scale = new(24);
            dp.Color = accessory.Data.DefaultDangerColor;
        ...
        [ScriptMethod(name: "Gymnastics Fan", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:36808"])]
        public void GymnasticsFan(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "Gymnastics Fan";
            dp.Scale = new(50);
        ...
        [ScriptMethod(name: "T Tower Fan", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:36889"])]
        public void TTowerFan(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "T Tower Fan";
            dp.Scale = new(40);
        ...
        #region Ice
        [ScriptMethod(name: "Avalanche Front Right", eventType: EventTypeEnum.EnvControl, eventCondition: ["Id:00200010", "Index:00000003"])]
        public void AvalancheFrontRight(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "Avalanche Front Right";
            dp.Scale = new(50,24);
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Position = new(100, 0, 100);
        ...
        [ScriptMethod(name: "Avalanche Back Left", eventType: EventTypeEnum.EnvControl, eventCondition: ["Id:00020001", "Index:00000003"])]
        public void AvalancheBackLeft(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = "Avalanche Front Right";
            dp.Scale = new(50,24);
        ...
        [ScriptMethod(name: "Ice Flower Cross Safe Zone", eventType: EventTypeEnum.AddCombatant, eventCondition: ["DataId:16667"])]
        public void IceFlowerCrossSafeZone(Event @event, ScriptAccessory accessory)
        {
            lock (icelock)
            {
                if (iceCross) return;
                ...
                if ((pos - pos11).Length() < 1f || (pos - pos12).Length() < 1f || (pos - pos13).Length() < 1f || (pos - pos14).Length() < 1f || (pos - pos15).Length() < 1f)
                {
                    ...
                    var dp = accessory.Data.GetDefaultDrawProperties();
                    dp.Name = $"Ice Flower Cross Safe Zone";
        ...
        #region Stack and Pillars
        [ScriptMethod(name: "Stack and Pillars Range", eventType: EventTypeEnum.ActionEffect, eventCondition: ["ActionId:34722"])]
        public void StackAndPillars(Event @event, ScriptAccessory accessory)
        {
            var dp = accessory.Data.GetDefaultDrawProperties();
            dp.Name = $"Stack and Pillars";
            dp.Scale = new(6,80);
            dp.Color = accessory.Data.DefaultSafeColor;
