...
[ScriptType(name: "LV.25 All's Well that Ends in the Well", territorys: [220], guid: "dbd92ba8-72a6-471b-a249-f1afdfcf99bb",
...
public class All_s_Well_that_Ends_in_the_Well
{
    ...
    [ScriptMethod(name: "Petribreath", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:505"])]
    ...
    public async void notify(Event @event, ScriptAccessory accessory)
    {
        ...
        accessory.TTS("Prioritize attacking Briaxio", isTTS, isDRTTS);
    ...
    [ScriptMethod(name: "Paralyze", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:308"])]
    public void Paralyze(Event @event, ScriptAccessory accessory)
    {
        if (isText) accessory.Method.TextInfo("Be ready to interrupt Briaxio", duration: 3700, true);
        accessory.TTS("Be ready to interrupt Briaxio", isTTS, isDRTTS);
    }

    [ScriptMethod(name: "Remove Draw", eventType: EventTypeEnum.Director, eventCondition: ["Command:80000022", "Instance:80032717"])]
